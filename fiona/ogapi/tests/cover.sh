...
case $COVER in
  "ZCOV")
    ...
    ZCOV="/home/jeed/workspace/ogapi/tests/zcov/zcov-scan"
    ...
    # scan directory
    $ZCOV /home/jeed/workspace/ogapi/tests/cover/$TESTNAME.zcov /home/jeed/workspace/ogapi &> /dev/null
  ...
  "LCOV")
    ...
    LCOV="/home/jeed/workspace/ogapi/tests/lcov/lcov --quiet"
    ...
    dir=`pwd`
    TESTNAME=`basename $dir`
    INFOFILE=/home/jeed/workspace/ogapi/tests/cover/$TESTNAME-$RANDOM.info

    # reset counters for LCOV
    $LCOV --zerocounters -directory /home/jeed/workspace/ogapi
    ...
    $LCOV --capture --directory /home/jeed/workspace/ogapi --output-file $INFOFILE --test-name $TESTNAME

    # remove profile information on C++ sources and headers
    $LCOV --extract $INFOFILE "/home/jeed/workspace/ogapi/*" -o $INFOFILE
