 ...
 *
 */
public abstract class DiagramEditorUtil extends EditorUtil implements IDiagramEditorUtil {

	public DiagramEditorUtil (org.eclipse.ui.part.EditorPart editor) {
		super(editor);
	}

	
	/**
	 * the default diagram editor utils (wrapping GMF routines) write their
	 * own initial model
