 ...
 * @generated
 */
public class SimpleActivityViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = FlowchartVisualIDRegistry
          .getType(SimpleActivityEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        FlowchartVisualIDRegistry
            .getType(SimpleActivityLabelEditPart.VISUAL_ID), ViewUtil.APPEND,
