...
case $COVER in
  "ZCOV")
    ...
    ZCOV="/home/jeed/workspace/sayo/tests/zcov/zcov-scan"
    ...
    # scan directory
    $ZCOV /home/jeed/workspace/sayo/tests/cover/$TESTNAME.zcov /home/jeed/workspace/sayo &> /dev/null
  ...
  "LCOV")
    ...
    LCOV="/home/jeed/workspace/sayo/tests/lcov/lcov --quiet"
    ...
    dir=`pwd`
    TESTNAME=`basename $dir`
    INFOFILE=/home/jeed/workspace/sayo/tests/cover/$TESTNAME-$RANDOM.info

    # reset counters for LCOV
    $LCOV --zerocounters -directory /home/jeed/workspace/sayo
    ...
    $LCOV --capture --directory /home/jeed/workspace/sayo --output-file $INFOFILE --test-name $TESTNAME

    # remove profile information on C++ sources and headers
    $LCOV --extract $INFOFILE "/home/jeed/workspace/sayo/*" -o $INFOFILE
