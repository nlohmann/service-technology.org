...
*/
  ...
  unsigned int secondDot = label.find_first_of(".");
  if (secondDot != string::npos)
	  secondDot = label.find_first_of(".", secondDot+1);
  if (secondDot != string::npos) // insert a line-break
	  label = label.insert(secondDot+1, "\\n");
// <Dirk.F end>  
