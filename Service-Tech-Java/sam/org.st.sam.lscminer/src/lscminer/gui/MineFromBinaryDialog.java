...
import lscminer.tracer.BinaryMethodCallTracer;

/**
 *
 * @author nacuong
 */
public class MineFromBinaryDialog extends javax.swing.JDialog {
    ...
    public MineFromBinaryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        mineStatus = false;
  ...
  private void initComponents() {
    ...
    binaryFileLabel = new javax.swing.JLabel();
    ...
    binaryFileTextField = new javax.swing.JTextField();
    classpathBrowseButton = new javax.swing.JButton();

    setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
    setTitle("Mine from Binary Program Dialog");
    setIconImage(null);
    setIconImages(null);
    ...
    binaryFileLabel.setFont(new java.awt.Font("Tahoma", 0, 12));
    binaryFileLabel.setText("Binary file :");
    ...
    binaryFileTextField.setFont(new java.awt.Font("Tahoma", 0, 12));
    binaryFileTextField.setToolTipText("The classpath of the main class file");
    binaryFileTextField.setEnabled(false);
    binaryFileTextField.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        binaryFileTextFieldActionPerformed(evt);
      }
    });
    ...
    jPanel1Layout.setHorizontalGroup(
      ...
      .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(jPanel1Layout.createSequentialGroup()
            .addComponent(binaryFileTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGap(18, 18, 18)
    ...
    jPanel1Layout.setVerticalGroup(
      ...
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
          .addComponent(binaryFileLabel)
          .addComponent(binaryFileTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void startMiningButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startMiningButtonActionPerformed
        ...
        if (!createProjectError) {
            taskName = taskNameTextField.getText();
            binaryFile = binaryFileTextField.getText();
            ...
            if (taskName.equals("")) {
                ...
                binaryFileTextField.requestFocusInWindow();
        ...
        if (!createProjectError && !miningParameterError) {
            ...
            BinaryMethodCallTracer binaryTracer = new BinaryMethodCallTracer(Main.getPinLoc(),Main.getBTraceLoc());
            LSCEvent[][] dataSet = binaryTracer.trace(binaryFile, inputFile);
            // </editor-fold>
            if (dataSet == null){
                JOptionPane.showMessageDialog(this, "Fail to run with input " + binaryTracer.getFailInput(), "Error Message", JOptionPane.WARNING_MESSAGE);
            } else {
    ...
    private void binaryFileTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_binaryFileTextFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_binaryFileTextFieldActionPerformed
    ...
    private void classpathBrowseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_classpathBrowseButtonActionPerformed
        JFileChooser binaryChooser = new JFileChooser();
        binaryChooser.setCurrentDirectory(new File(System.getProperty("user.dir")));
        binaryChooser.setDialogTitle("Select Java Classpath");
        binaryChooser.setApproveButtonText("Select");
        binaryChooser.setApproveButtonToolTipText("Select java classpath");
        binaryChooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
        binaryChooser.setAcceptAllFileFilterUsed(true);
        binaryChooser.addChoosableFileFilter(new BinaryFilter());

        if (binaryChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            String classpath = binaryFileTextField.getText();
            if (!classpath.trim().isEmpty()){
                classpath += ";" + binaryChooser.getSelectedFile().getPath();
            } else {
                classpath = binaryChooser.getSelectedFile().getPath();
            }
            binaryFileTextField.setText(classpath);
        }
    }//GEN-LAST:event_classpathBrowseButtonActionPerformed

  // Variables declaration - do not modify//GEN-BEGIN:variables
  private javax.swing.JButton advancedSettingsButton;
  private javax.swing.JLabel binaryFileLabel;
  private javax.swing.JTextField binaryFileTextField;
