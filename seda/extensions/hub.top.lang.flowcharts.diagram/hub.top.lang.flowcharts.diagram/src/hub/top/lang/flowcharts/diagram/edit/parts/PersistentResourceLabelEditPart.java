 ...
 * @generated
 */
public class PersistentResourceLabelEditPart extends CompartmentEditPart
   ...
   * @generated
   */
  public PersistentResourceLabelEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new FlowchartParserProvider.HintAdapter(
          FlowchartElementTypes.PersistentResource_1011, getParserElement(),
          parserHint);
