...
public:
	...
	LTLStackEntry(index_t * f,index_t cf,index_t * _states, index_t cs, index_t ls, AutomataTree* dfs_low) {
    ...
    // pointer to the location of the lowlink and dfs number of this node
    AutomataTree* dfs_lowlink;
};
