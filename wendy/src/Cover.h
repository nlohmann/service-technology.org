...
public: /* data structures */
  ...
  struct CoverData
  {
    std::vector<unsigned int> inP; // internal places
    std::vector<unsigned int> comP; // interface places
    std::vector<unsigned int> inT; // internal transitions
    std::vector<unsigned int> comT; // interface transitions
  };
