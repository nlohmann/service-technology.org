package hub.top.editor.ptnetLoLA.diagram.parsers;
			...
			if (Boolean.TYPE.equals(iClass)) {
				if (value instanceof Boolean) {
					...
					value = new InvalidValue(
							NLS
									.bind(
											hub.top.editor.ptnetLoLA.diagram.part.Messages.AbstractParser_UnexpectedValueTypeMessage,
											iClass.getName()));
				}
					...
					if (s.length() == 0) {
						...
						try {
							...
							value = new InvalidValue(
									NLS
											.bind(
													hub.top.editor.ptnetLoLA.diagram.part.Messages.AbstractParser_WrongStringConversionMessage,
													iClass.getName()));
						}
					}
				} else {
				...
				if (value instanceof String) {
					...
					if (literal == null) {
						value = new InvalidValue(
								NLS
										.bind(
												hub.top.editor.ptnetLoLA.diagram.part.Messages.AbstractParser_UnknownLiteralMessage,
												value));
					} else {
