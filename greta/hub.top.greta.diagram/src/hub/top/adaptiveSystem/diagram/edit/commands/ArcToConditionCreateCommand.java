 ...
 * @generated
 */
public class ArcToConditionCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public ArcToConditionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return hub.top.adaptiveSystem.diagram.edit.policies.AdaptiveSystemBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateArcToCondition_3001(getContainer(), getSource(),
						getTarget());
	}
	 ...
	 * @generated
	 */
	protected hub.top.adaptiveSystem.Event getSource() {
		return (hub.top.adaptiveSystem.Event) source;
	}

	/**
	 * @generated
	 */
	protected hub.top.adaptiveSystem.Condition getTarget() {
		return (hub.top.adaptiveSystem.Condition) target;
	}
