 ...
 * @generated
 */
public class SplitNodeLabel2EditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public SplitNodeLabel2EditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new FlowchartParserProvider.HintAdapter(
          FlowchartElementTypes.SplitNode_2006, getParserElement(), parserHint);
