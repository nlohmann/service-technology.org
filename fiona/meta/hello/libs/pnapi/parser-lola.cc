...
{
       0,    69,    69,    74,    83,    97,    98,   101,   103,   104,
     108,   113,   124,   126,   127,   131,   144,   145,   150,   155,
     161,   149,   168,   170,   171,   175
};
#endif
...
#line 176 "parser-lola.yy"
    {
      ...
      if(a != NULL)
      {
        a->setWeight(a->getWeight() + (yyvsp[(3) - (3)].yt_int));
      }
      else
      {
