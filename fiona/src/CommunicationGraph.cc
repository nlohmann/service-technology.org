...
/*!
 * \brief  returns true iff a colored successor of v can be avoided
 *
 * \param  v  node under consideration
 *
 * \return true iff there is either a sending edge to a non-colored successor or,
