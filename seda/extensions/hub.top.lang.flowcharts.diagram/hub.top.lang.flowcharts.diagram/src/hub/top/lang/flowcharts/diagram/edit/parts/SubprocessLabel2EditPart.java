 ...
 * @generated
 */
public class SubprocessLabel2EditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public SubprocessLabel2EditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new FlowchartParserProvider.HintAdapter(
          FlowchartElementTypes.Subprocess_2004, getParserElement(), parserHint);
