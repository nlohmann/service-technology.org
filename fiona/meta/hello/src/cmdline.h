...
struct gengetopt_args_info
{
  ...
  char * output_arg;	/**< @brief Wendy's output..  */
  char * output_orig;	/**< @brief Wendy's output. original value given at command line.  */
  const char *output_help; /**< @brief Wendy's output. help description.  */
  ...
  char * wendy_arg;	/**< @brief Set the path and binary of Wendy. (default='wendy').  */
  char * wendy_orig;	/**< @brief Set the path and binary of Wendy. original value given at command line.  */
  const char *wendy_help; /**< @brief Set the path and binary of Wendy. help description.  */
  char * tmpfile_arg;	/**< @brief Set the path and name of temporary files. (default='/tmp/hello-XXXXXX').  */
  ...
  int bug_flag;	/**< @brief Write configuration information into a file `bug.log'. (default=off).  */
  const char *bug_help; /**< @brief Write configuration information into a file `bug.log'. help description.  */
  ...
  unsigned int bug_given ;	/**< @brief Whether bug was given.  */
