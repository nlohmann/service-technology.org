...
using pnapi::io::FileIO;
using pnapi::io::PetriNetIO;
...
namespace pnapi
{
  ...
  void PetriNet::output_owfn(ostream & os) const
  {
    os  //< output everything to this stream
      ...
      << "  input file:   " << FileIO::getFilename(os) << endl
      //<< "  invocation:   " << "<unknown>"             << endl
      << "  net size:     " << stat << *this << owfn   << endl
      << "}" << endl 
      << endl

      << "PLACE"      << endl
      << setMode(PetriNetIO::PLACE_CAPACITY)
      << "  INTERNAL" << endl
      << "    " << internalPlaces_ << ";" << endl << endl
      << setMode(PetriNetIO::PLACE)
      << "  INPUT"    << endl
      ...
      << setMode(PetriNetIO::PLACE_TOKEN)
      << "INITIALMARKING" << endl
      << "  " << PetriNetIO::filterMarkedPlaces(internalPlaces_) << ";" << endl 
      << endl
