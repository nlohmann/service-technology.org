...
public class ConvertDiagramFileAction_FCtoINA extends ConvertDiagramFileAction {
	...
	{
		ConvertFileWizard wizard = new ConvertFileWizard_FCtoINA(
				srcURI, root, editingDomain, "pnt");
		wizard.setWindowTitle("Convert Flowchart to INA File");
		return wizard;
	}
}
