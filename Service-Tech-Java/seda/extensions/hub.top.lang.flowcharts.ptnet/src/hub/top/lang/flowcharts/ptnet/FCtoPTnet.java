...
public class FCtoPTnet extends Translator {
	...
	public void translate() {
		translateAllChildNodes();
		translateAllChildArcs();

		super.translate();
	}
	
	protected void translateAllChildNodes() {
    this.setPlaceNum(1);
    this.setTransitionNum(1);
