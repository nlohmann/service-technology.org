...
/**
 * This is the item provider adapter for a {@link hub.top.lang.flowcharts.Workflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkflowItemProvider
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FlowPackage.Literals.WORKFLOW__PROCESSES);
		}
  ...
  public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Workflow.class)) {
			case FlowPackage.WORKFLOW__PROCESSES:
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.WORKFLOW__PROCESSES,
				 FlowFactory.eINSTANCE.createWorkflowDiagram()));
	}
