 ...
 * @generated
 */
public class ArcToTransitionReorientCommand extends EditElementCommand {
   ...
   * @generated
   */
  public ArcToTransitionReorientCommand(ReorientRelationshipRequest request) {
  ...
  public boolean canExecute() {
    if (false == getElementToEdit() instanceof hub.top.editor.ptnetLoLA.ArcToTransition) {
      return false;
    }
  ...
  protected boolean canReorientSource() {
    ...
    return hub.top.editor.ptnetLoLA.diagram.edit.policies.PtnetLoLABaseItemSemanticEditPolicy
        .getLinkConstraints().canExistArcToTransition_4002(container,
   ...
   * @generated
   */
  protected hub.top.editor.ptnetLoLA.ArcToTransition getLink() {
    return (hub.top.editor.ptnetLoLA.ArcToTransition) getElementToEdit();
  }
