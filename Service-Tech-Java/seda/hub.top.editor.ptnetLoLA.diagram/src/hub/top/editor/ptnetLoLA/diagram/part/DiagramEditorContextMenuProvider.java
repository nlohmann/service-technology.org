...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private hub.top.editor.ptnetLoLA.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new hub.top.editor.ptnetLoLA.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
