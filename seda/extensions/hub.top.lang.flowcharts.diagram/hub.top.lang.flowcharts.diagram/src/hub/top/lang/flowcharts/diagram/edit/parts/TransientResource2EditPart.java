...
import hub.top.lang.flowcharts.diagram.edit.policies.TransientResource2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TransientResource2EditPart extends ShapeNodeEditPart {
   ...
   * @generated
   */
  public TransientResource2EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new TransientResource2ItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof TransientResourceLabel2EditPart) {
      ((TransientResourceLabel2EditPart) childEditPart)
