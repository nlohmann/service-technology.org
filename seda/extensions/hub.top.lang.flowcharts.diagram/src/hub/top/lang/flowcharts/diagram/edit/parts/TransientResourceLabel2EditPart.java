 ...
 * @generated
 */
public class TransientResourceLabel2EditPart extends CompartmentEditPart
   ...
   * @generated
   */
  public TransientResourceLabel2EditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new FlowchartParserProvider.HintAdapter(
          FlowchartElementTypes.TransientResource_3009, getParserElement(),
          parserHint);
