...
{
       0,     0,     3,     4,     5,    14,    15,    16,    21,    22,
      23,    28,    29,    30,    35,    36,    38,    42,    44,    47,
      48,    53,    54,    57,    60,    63,    66,    70,    74,    78,
      81,    83,    85,    87,    89,    90
};
...
{
      27,     0,    -1,    -1,    -1,    28,     4,    30,    32,    34,
       3,    29,    37,    -1,    -1,    -1,     5,    31,    36,    11,
      -1,    -1,    -1,     6,    33,    36,    11,    -1,    -1,    -1,
       7,    35,    36,    11,    -1,    -1,    12,    -1,    36,     8,
      12,    -1,    38,    -1,    37,    38,    -1,    -1,    14,    39,
      40,    42,    -1,    -1,     9,    41,    -1,    10,    19,    -1,
      10,    18,    -1,    10,    20,    -1,    21,    41,    22,    -1,
      41,    24,    41,    -1,    41,    23,    41,    -1,    25,    41,
      -1,    17,    -1,    15,    -1,    16,    -1,    12,    -1,    -1,
      42,    12,    13,    14,    -1
};
...
{
       0,   138,   138,   153,   138,   189,   191,   191,   196,   198,
     198,   203,   206,   205,   214,   216,   243,   274,   275,   281,
     280,   375,   376,   381,   382,   383,   388,   389,   390,   391,
     392,   393,   394,   395,   403,   405
};
#endif
...
static const char *const yytname[] =
{
  ...
  "OP_OR", "OP_AND", "OP_NOT", "$accept", "og", "$@1", "$@2", "input",
  "$@3", "output", "$@4", "synchronous", "$@5", "identlist", "nodes",
  "node", "$@6", "annotation", "formula", "successors", 0
};
#endif
...
{
       0,    26,    28,    29,    27,    30,    31,    30,    32,    33,
      32,    34,    35,    34,    36,    36,    36,    37,    37,    39,
...
{
       2,     0,     0,     1,     5,     6,     8,    14,     9,    11,
      15,     0,    14,    12,     0,     0,     7,     0,    14,     3,
      16,    10,     0,     0,    13,    19,     4,    17,    21,    18,
       0,     0,    34,    33,    31,    32,    30,     0,     0,    22,
      24,    23,    25,    20,     0,    29,     0,     0,     0,    26,
      28,    27,     0,    35
};
...
{
      -1,     1,     2,    23,     6,     7,     9,    12,    14,    18,
      11,    26,    27,    28,    32,    39,    43
};
...
{
     -37,    28,    25,   -37,    26,   -37,    24,    20,   -37,    27,
     -37,     6,    20,   -37,    30,    23,   -37,     7,    20,   -37,
     -37,   -37,     8,    22,   -37,   -37,    22,   -37,    -2,   -37,
     -12,     2,   -37,   -37,   -37,   -37,   -37,   -12,   -12,     3,
     -37,   -37,   -37,    29,     1,   -37,   -12,   -12,    31,   -37,
      13,   -37,    32,   -37
};
...
{
      33,    44,    45,    34,    35,    36,    17,    30,    31,    37,
      50,    51,    22,    38,    15,    15,    15,    16,    21,    24,
      40,    41,    42,    49,    46,    47,    46,    47,     3,     4,
       8,     5,    10,    19,    13,    20,    25,    47,    29,     0,
       0,    48,     0,     0,    52,     0,    53
};

static const yytype_int8 yycheck[] =
{
      12,    37,    38,    15,    16,    17,    12,     9,    10,    21,
      46,    47,    18,    25,     8,     8,     8,    11,    11,    11,
      18,    19,    20,    22,    23,    24,    23,    24,     0,     4,
       6,     5,    12,     3,     7,    12,    14,    24,    26,    -1,
      -1,    12,    -1,    -1,    13,    -1,    14
};
...
{
       0,    27,    28,     0,     4,     5,    30,    31,     6,    32,
      12,    36,    33,     7,    34,     8,    11,    36,    35,     3,
      12,    11,    36,    29,    11,    14,    37,    38,    39,    38,
       9,    10,    40,    12,    15,    16,    17,    21,    25,    41,
      18,    19,    20,    42,    41,    41,    23,    24,    12,    22,
      41,    41,    13,    14
};
...
/* Line 1455 of yacc.c  */
#line 191 "syntax_og.yy"
    { identType = T_INPUT; /* now reading input labels */ }
    break;

  case 9:

/* Line 1455 of yacc.c  */
#line 198 "syntax_og.yy"
    { identType = T_OUTPUT; /* now reading output labels */}
    break;

  case 12:

/* Line 1455 of yacc.c  */
#line 206 "syntax_og.yy"
    {
...
/* Line 1455 of yacc.c  */
#line 244 "syntax_og.yy"
    {
    switch(identType) // what type of label is read
    {
      case T_INPUT: // reading input, writing output
      {
        string tmpStr = (yyvsp[(3) - (3)].str);
        outputLabels.push_back(tmpStr);
        break;
      }
      case T_OUTPUT: // reading output, writing input
...
/* Line 1455 of yacc.c  */
#line 281 "syntax_og.yy"
    { 
    // Don't copy the empty node, i.e. node 0 from the og.
    emptyNode = ((yyvsp[(1) - (1)].value) == 0);
    if(emptyNode)
      break;
    ...
    if(initialState)
    {
      (*myOut) << "  " << mapNode((yyvsp[(1) - (1)].value)) << ": INITIAL\n";
      initialState = false;
    }
    else
    {
      (*myOut) << "  " << mapNode((yyvsp[(1) - (1)].value)) << "\n";
    }
...
#line 310 "syntax_og.yy"
     ...
     */
    switch((yyvsp[(3) - (4)].flag))
    {
      case 't':
      {
        // add TAU-loop
        (*myOut) << "    TAU -> " << mapNode((yyvsp[(1) - (4)].value)) << "\n";
        break; 
      }
      case 's':
      case 'f':
...
/* Line 1455 of yacc.c  */
#line 406 "syntax_og.yy"
    {
    // don't copy the empty node or arcs to the empty node
    if( (emptyNode) || ((yyvsp[(4) - (4)].value) == 0) )
    {
    ...
    (*myOut) << "    " << (yyvsp[(2) - (4)].str) << " -> " << mapNode((yyvsp[(4) - (4)].value)) << "\n";
    
    // store successor (i.e. overwrite link to node 0)
    inputSockets[inputIndex[(yyvsp[(2) - (4)].str)]] = mapNode((yyvsp[(4) - (4)].value));
