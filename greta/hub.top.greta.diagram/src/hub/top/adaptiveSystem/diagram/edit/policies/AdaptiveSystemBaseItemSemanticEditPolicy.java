 ...
 * @generated
 */
public class AdaptiveSystemBaseItemSemanticEditPolicy extends
		SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateArcToCondition_3001(
				hub.top.adaptiveSystem.OccurrenceNet container,
				hub.top.adaptiveSystem.Event source,
				hub.top.adaptiveSystem.Condition target) {
			return canExistArcToCondition_3001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateArcToEvent_3002(
				hub.top.adaptiveSystem.OccurrenceNet container,
				hub.top.adaptiveSystem.Condition source,
				hub.top.adaptiveSystem.Event target) {
			return canExistArcToEvent_3002(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistArcToCondition_3001(
				hub.top.adaptiveSystem.OccurrenceNet container,
				hub.top.adaptiveSystem.Event source,
				hub.top.adaptiveSystem.Condition target) {
			return true;
		 ...
		 * @generated
		 */
		public static boolean canExistArcToEvent_3002(
				hub.top.adaptiveSystem.OccurrenceNet container,
				hub.top.adaptiveSystem.Condition source,
				hub.top.adaptiveSystem.Event target) {
			return true;
