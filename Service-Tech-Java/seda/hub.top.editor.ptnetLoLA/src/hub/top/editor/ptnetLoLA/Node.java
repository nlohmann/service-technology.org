...
public interface Node extends EObject {
	...
	/**
	 * @return a list of all direct predecessor nodes of this node
	 */
	EList<? extends Node> getPreSet();

  /**
   * @return a list of all direct successor nodes of this node
   */
	EList<? extends Node> getPostSet();
