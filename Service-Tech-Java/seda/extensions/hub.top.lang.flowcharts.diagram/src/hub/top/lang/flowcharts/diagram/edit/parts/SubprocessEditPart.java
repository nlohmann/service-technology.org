...
import hub.top.lang.flowcharts.diagram.edit.policies.SubprocessItemSemanticEditPolicy;
...
public class SubprocessEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof SubprocessLabelEditPart) {
      ((SubprocessLabelEditPart) childEditPart).setLabel(getPrimaryShape()
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(FlowchartVisualIDRegistry
        .getType(SubprocessLabelEditPart.VISUAL_ID));
  }
