...
public class FlowPackageImpl extends EPackageImpl implements FlowPackage {
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see hub.top.lang.flowcharts.FlowPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getActivityNode_MinTime() {
		return (EAttribute)activityNodeEClass.getEStructuralFeatures().get(5);
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EAttribute getActivityNode_Cost() {
		return (EAttribute)activityNodeEClass.getEStructuralFeatures().get(6);
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EAttribute getActivityNode_Probability() {
		return (EAttribute)activityNodeEClass.getEStructuralFeatures().get(7);
	}
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getActivityNode_MaxTime() {
		return (EAttribute)activityNodeEClass.getEStructuralFeatures().get(8);
	}
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getSubprocess_Weight() {
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getDiagramArc_MinWeight() {
		return (EAttribute)diagramArcEClass.getEStructuralFeatures().get(5);
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EAttribute getDiagramArc_Probability() {
		return (EAttribute)diagramArcEClass.getEStructuralFeatures().get(4);
	}
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getDiagramArc_MaxWeight() {
		return (EAttribute)diagramArcEClass.getEStructuralFeatures().get(6);
	}
  ...
  public void createPackageContents() {
		...
		createEAttribute(activityNodeEClass, ACTIVITY_NODE__MIN_TIME);
		createEAttribute(activityNodeEClass, ACTIVITY_NODE__COST);
		createEAttribute(activityNodeEClass, ACTIVITY_NODE__PROBABILITY);
		createEAttribute(activityNodeEClass, ACTIVITY_NODE__MAX_TIME);
		...
		createEAttribute(subprocessEClass, SUBPROCESS__WEIGHT);
		...
		createEAttribute(diagramArcEClass, DIAGRAM_ARC__PROBABILITY);
		createEAttribute(diagramArcEClass, DIAGRAM_ARC__MIN_WEIGHT);
		createEAttribute(diagramArcEClass, DIAGRAM_ARC__MAX_WEIGHT);
	}
  ...
  public void initializePackageContents() {
		...
		initEAttribute(getActivityNode_MinTime(), ecorePackage.getEInt(), "minTime", "0", 0, 1, ActivityNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityNode_Cost(), ecorePackage.getEInt(), "cost", "0", 0, 1, ActivityNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityNode_Probability(), ecorePackage.getEDouble(), "probability", "1.0", 0, 1, ActivityNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityNode_MaxTime(), ecorePackage.getEInt(), "maxTime", "0", 0, 1, ActivityNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSubprocess_Weight(), ecorePackage.getEInt(), "weight", "1", 0, 1, Subprocess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDiagramArc_Probability(), ecorePackage.getEDouble(), "probability", "1.0", 0, 1, DiagramArc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDiagramArc_MinWeight(), ecorePackage.getEInt(), "minWeight", "1", 0, 1, DiagramArc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDiagramArc_MaxWeight(), ecorePackage.getEInt(), "maxWeight", "1", 0, 1, DiagramArc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
