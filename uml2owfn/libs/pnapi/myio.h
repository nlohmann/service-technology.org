...
// <Dirk.F> added support for Woflan, added 2 lines
...
// <Dirk.F> added support for Woflan, added WOFLAN to Format line
      /// possible I/O formats
      enum Format { STAT, OWFN, DOT, GASTEX, ONWD, SA, SA2SM, LOLA, WOFLAN };
...
// <Dirk.F> added support for Woflan, added entire namespace __woflan
    //****************************
    //*** Woflan output format ***
    //****************************
