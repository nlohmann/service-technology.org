...
public class ConvertDiagramFileAction_PTnetToTINA extends ConvertDiagramFileAction {


	/**
	 * Create a {@link ConvertFileWizard_PTnetToTINA} to convert a selected
	 * P/T net to an TINA document.
	 * 
	...
	{
		ConvertFileWizard wizard = new ConvertFileWizard_PTnetToTINA(
				srcURI, root, editingDomain, "net");
		wizard.setWindowTitle("Convert P/T-Net to TINA file");
		return wizard;
	}
}
