 ...
 * @generated
 */
public class EventPreNetItemSemanticEditPolicy
		extends
	...
	public boolean equalParentNet(CreateRelationshipRequest req) {
		//System.out.println("EventPreNetItemSemanticEditPolicy.equalParentNet(req) START.");
	...
	/**
	 * Manja Wolf
	 * check during reorientation of arcToCondition that the arc is in the same parentNet (Oclet or AdaptiveProcess) 
	 * 
	 */
	public boolean equalParentNet(ReorientRelationshipRequest req) {
		//System.out.println("EventPreNetItemSemanticEditPolicy.equalParentNet(ReorientReq) START.");
			...
			if (req.getRelationship() instanceof ArcToCondition) {
				...
				if (source.eContainer() instanceof PreNet
					...
					if (req.getOldRelationshipEnd().equals(source)
							&& req.getNewRelationshipEnd() instanceof Event
				...
				if (source.eContainer() instanceof DoNet
					...
					if (req.getOldRelationshipEnd().equals(destination)
							&& req.getNewRelationshipEnd() instanceof Condition
