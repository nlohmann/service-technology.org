 ...
 * @generated
 */
public class Document2ViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = FlowchartVisualIDRegistry
          .getType(Document2EditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        FlowchartVisualIDRegistry.getType(DocumentLabel2EditPart.VISUAL_ID),
