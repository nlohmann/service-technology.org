...
static const char qt_meta_stringdata_MonitorWidget[] = {
    "MonitorWidget\0"
};

const QMetaObject MonitorWidget::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_MonitorWidget,
      qt_meta_data_MonitorWidget, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MonitorWidget))
        return static_cast<void*>(const_cast< MonitorWidget*>(this));
