...
import hub.top.lang.flowcharts.diagram.edit.policies.Subprocess2ItemSemanticEditPolicy;
...
public class Subprocess2EditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof SubprocessLabel2EditPart) {
      ((SubprocessLabel2EditPart) childEditPart).setLabel(getPrimaryShape()
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(FlowchartVisualIDRegistry
        .getType(SubprocessLabel2EditPart.VISUAL_ID));
  }
