 ...
 * @generated
 */
public class AdaptiveSystemDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public AdaptiveSystemDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof hub.top.adaptiveSystem.diagram.navigator.AdaptiveSystemDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((hub.top.adaptiveSystem.diagram.navigator.AdaptiveSystemDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result
						.add(new hub.top.adaptiveSystem.diagram.navigator.AdaptiveSystemDomainNavigatorItem(
