...
void PetriNet::owfnOut()
{
  ...
  (*output) << "  generated by: " << PACKAGE_STRING << " (see http://www.informatik.hu-berlin.de/top/tools4bpel/bpel2owfn)" << endl;
  (*output) << "  input file:   `" << filename << "' (process `" << ASTEmap[1]->attributes["name"] << "')" << endl;
#endif
#ifndef USING_BPEL2OWFN
  (*output) << "  generated by: " << PACKAGE_STRING << " (see http://www.informatik.hu-berlin.de/top/tools4bpel/pnml2owfn)" << endl;
