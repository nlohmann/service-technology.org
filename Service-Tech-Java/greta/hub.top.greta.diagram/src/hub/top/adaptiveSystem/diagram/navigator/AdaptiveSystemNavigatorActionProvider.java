 ...
 * @generated
 */
public class AdaptiveSystemNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					hub.top.adaptiveSystem.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof hub.top.adaptiveSystem.diagram.navigator.AdaptiveSystemNavigatorItem) {
					selectedElement = ((hub.top.adaptiveSystem.diagram.navigator.AdaptiveSystemNavigatorItem) selectedElement)
							.getView();
