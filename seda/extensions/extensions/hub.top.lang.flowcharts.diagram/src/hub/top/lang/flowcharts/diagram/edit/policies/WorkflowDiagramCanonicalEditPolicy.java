...
public class WorkflowDiagramCanonicalEditPolicy extends
  ...
  protected List getSemanticChildrenList() {
    ...
    for (Iterator it = FlowchartDiagramUpdater
        .getWorkflowDiagram_79SemanticChildren(viewObject).iterator(); it
        .hasNext();) {
  ...
  private Collection collectAllLinks(View view, Map domain2NotationMap) {
    ...
    case WorkflowDiagramEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getWorkflowDiagram_79ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
    ...
    case StartNodeEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getStartNode_1001ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case EndnodeEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getEndnode_1002ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case SimpleActivityEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getSimpleActivity_1003ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case SubprocessEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getSubprocess_1004ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case EventEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result
            .addAll(FlowchartDiagramUpdater.getEvent_1005ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case SplitNodeEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getSplitNode_1006ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case MergeNodeEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getMergeNode_1007ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case FlowEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater.getFlow_1008ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case TransientResourceEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getTransientResource_1009ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case DocumentEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getDocument_1010ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case PersistentResourceEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getPersistentResource_1011ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
    ...
    case DiagramArcEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(FlowchartDiagramUpdater
            .getDiagramArc_3001ContainedLinks(view));
      }
      if (!domain2NotationMap.containsKey(view.getElement())
          || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
        domain2NotationMap.put(view.getElement(), view);
