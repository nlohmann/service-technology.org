...
%token K_RESOURCES K_ROLEREQUIREMENT K_RESOURCEQUANTITY
%token NUMBER
%token X_NAME
%token VARIABLENAME
%token X_STRING
...
tResources:
  ...
  tRoleRequirement_list
  X_SLASH K_RESOURCES
| K_RESOURCES arbitraryAttributes X_SLASH
;
tRoleRequirement_list:
  /* empty */
| tRoleRequirement X_NEXT tRoleRequirement_list
;
tRoleRequirement:
  K_ROLEREQUIREMENT arbitraryAttributes X_NEXT
  tResourceQuantity
  X_NEXT X_SLASH K_ROLEREQUIREMENT
| K_ROLEREQUIREMENT arbitraryAttributes X_NEXT
  X_SLASH K_ROLEREQUIREMENT
| K_ROLEREQUIREMENT arbitraryAttributes X_SLASH
;
tResourceQuantity:
