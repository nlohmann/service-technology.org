...
public class FlowFlowCompartmentItemSemanticEditPolicy extends
  ...
  protected Command getCreateCommand(CreateElementRequest req) {
    if (FlowchartElementTypes.StartNode_2001 == req.getElementType()) {
    ...
    if (FlowchartElementTypes.Endnode_2002 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.SimpleActivity_2003 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.Subprocess_2004 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.Event_2005 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.SplitNode_2006 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.MergeNode_2007 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.Flow_2008 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.TransientResource_2009 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.Document_2010 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
    ...
    if (FlowchartElementTypes.PersistentResource_2011 == req.getElementType()) {
      if (req.getContainmentFeature() == null) {
        req.setContainmentFeature(FlowPackage.eINSTANCE
            .getStructuredNode_ChildNodes());
      }
