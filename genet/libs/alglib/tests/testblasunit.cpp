...
bool testblas(bool silent)
{
    ...
    e2 = e2/scl2;
    e3 = e3/scl3;
    n2errors = e1>=10000*ap::machineepsilon||e2>=10000*ap::machineepsilon||e3>=10000*ap::machineepsilon;
    ...
    a(3,2) = 3;
    a(3,3) = 1;
    hsnerrors = fabs(upperhessenberg1norm(a, 1, 3, 1, 3, x1)-11)>10*ap::machineepsilon;
    ...
    mverrors = e1+e2>=50*ap::machineepsilon;
    ...
    for(pass = 1; pass <= passcount; pass++)
    {
        ...
        trans1 = ap::randomreal()>0.5;
        trans2 = ap::randomreal()>0.5;
        if( trans1 )
        {
            col1 = l;
            row1 = k;
...
bool testblasunit_test_silent()
{
    ...
    return result;
#else
    return _i_testblasunit_test_silent();
#endif
}
