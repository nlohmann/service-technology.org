...
// <Dirk.F> roles, added 3 lines
    /// returns a reference to the node's roles
...
// <Dirk.F> roles, added 2 lines
    /// the role annotations of this node
