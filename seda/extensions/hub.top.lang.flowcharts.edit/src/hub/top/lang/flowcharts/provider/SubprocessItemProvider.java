...
/**
 * This is the item provider adapter for a {@link hub.top.lang.flowcharts.Subprocess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubprocessItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subprocess_subprocess_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subprocess_subprocess_feature", "_UI_Subprocess_type"),
				 FlowPackage.Literals.SUBPROCESS__SUBPROCESS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addWeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subprocess_weight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subprocess_weight_feature", "_UI_Subprocess_type"),
				 FlowPackage.Literals.SUBPROCESS__WEIGHT,
				 true,
				 false,
				 false,
  ...
  public String getText(Object object) {
		String label = ((Subprocess)object).getLabel();
