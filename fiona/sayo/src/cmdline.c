...
const char *gengetopt_args_info_purpose = "Sayo (Service Automata Yielded from Operating guidelines) is a converter of \npublic view service automata from bit operating guidelines.";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [OPTIONS]...";

const char *gengetopt_args_info_description = "About Sayo:";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nInput / Output:",
  "  -i, --input=OG       Input file. If no file is given, the operating guideline \n                         will be read from standard in. ",
  "  -o, --output=SA      Output file. If no file is given, the service automaton \n                         will be written to standard out.",
  "\nDebugging:",
  "  These options control how much debug output Sayo creates.\n",
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[10] = 0; 
  
}

const char *gengetopt_args_info_full_help[11];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->stats_help = gengetopt_args_info_detailed_help[9] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* Input file. If no file is given, the operating guideline will be read from standard in. .  */
          ...
          break;
        case 'o':	/* Output file. If no file is given, the service automaton will be written to standard out..  */
