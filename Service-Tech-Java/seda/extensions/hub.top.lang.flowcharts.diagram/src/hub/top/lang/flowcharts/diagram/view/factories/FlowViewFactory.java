 ...
 * @generated
 */
public class FlowViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = FlowchartVisualIDRegistry.getType(FlowEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        FlowchartVisualIDRegistry
            .getType(FlowFlowCompartmentEditPart.VISUAL_ID), ViewUtil.APPEND,
