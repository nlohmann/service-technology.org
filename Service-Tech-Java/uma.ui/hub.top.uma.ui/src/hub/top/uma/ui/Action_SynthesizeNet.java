...
public class Action_SynthesizeNet implements IWorkbenchWindowActionDelegate {

	public static final String ID = "hub.top.uma.ui.oclets.SynthesizeNet";
    ...
    try {
      ...
      final DNodeRefold build = Uma.initBuildPrefix_Synthesis(sys, 1);
      ...
      Job bpBuildJob = new Job("constructing branching process") 
      {
        ...
        protected IStatus run(IProgressMonitor monitor) {
          ...
          monitor.subTask("writing net to files");
  ...
  public void selectionChanged(IAction action, ISelection selection) {
    ...
    try {
      ...
      if (selected.length == 1) {
        ...
        String[] sysExt = new String[] { "oclets" };
