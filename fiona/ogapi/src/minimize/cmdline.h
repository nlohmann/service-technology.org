...
struct gengetopt_args_info
{
  ...
  char * output_arg;	/**< @brief Specifying output filename..  */
  char * output_orig;	/**< @brief Specifying output filename. original value given at command line.  */
  const char *output_help; /**< @brief Specifying output filename. help description.  */
  ...
  char * tmpfile_arg;	/**< @brief Set the path and name of temporary files (default='/tmp/minimize-XXXXXX').  */
