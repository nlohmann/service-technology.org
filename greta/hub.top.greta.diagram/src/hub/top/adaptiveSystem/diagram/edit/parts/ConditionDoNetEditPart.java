 ...
 * @generated
 */
public class ConditionDoNetEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ConditionDoNetEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new hub.top.adaptiveSystem.diagram.edit.policies.ConditionDoNetItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof hub.top.adaptiveSystem.diagram.edit.parts.ConditionDoNetTokenEditPart) {
			((hub.top.adaptiveSystem.diagram.edit.parts.ConditionDoNetTokenEditPart) childEditPart)
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof hub.top.adaptiveSystem.diagram.edit.parts.ConditionDoNetNameEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			locator.setBorderItemOffset(new Dimension(-5, 4));
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof hub.top.adaptiveSystem.diagram.edit.parts.ConditionDoNetTempEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		if (notification.getNotifier() instanceof Condition) {
			if (feature instanceof EAttributeImpl) {
				...
				//temp or abstract of the node changed
				...
				//token of the condition changed
				if (attribute.getName().equals(
	...
	public class ConditionDescriptor extends Ellipse {
		...
		public ConditionDescriptor() {
			...
			this.setMaximumSize(new Dimension(getMapMode().DPtoLP(20),
					getMapMode().DPtoLP(20)));
			UserImplUpdateNode.updateCondition(ConditionDoNetEditPart.this,
					this);
			createContents();
		}
