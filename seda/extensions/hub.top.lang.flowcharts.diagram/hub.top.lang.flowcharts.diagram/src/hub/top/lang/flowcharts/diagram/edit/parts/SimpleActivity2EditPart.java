...
import hub.top.lang.flowcharts.diagram.edit.policies.SimpleActivity2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SimpleActivity2EditPart extends ShapeNodeEditPart {
   ...
   * @generated
   */
  public SimpleActivity2EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new SimpleActivity2ItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof SimpleActivityLabel2EditPart) {
      ((SimpleActivityLabel2EditPart) childEditPart).setLabel(getPrimaryShape()
