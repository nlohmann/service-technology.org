...
public class FlowchartElementTypes extends ElementInitializers {
   ...
   * @generated
   */
  public static final IElementType WorkflowDiagram_79 = getElementType("hub.top.lang.flowcharts.diagram.WorkflowDiagram_79"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType StartNode_1001 = getElementType("hub.top.lang.flowcharts.diagram.StartNode_1001"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType Endnode_1002 = getElementType("hub.top.lang.flowcharts.diagram.Endnode_1002"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType SimpleActivity_1003 = getElementType("hub.top.lang.flowcharts.diagram.SimpleActivity_1003"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType Subprocess_1004 = getElementType("hub.top.lang.flowcharts.diagram.Subprocess_1004"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType Event_1005 = getElementType("hub.top.lang.flowcharts.diagram.Event_1005"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType SplitNode_1006 = getElementType("hub.top.lang.flowcharts.diagram.SplitNode_1006"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType MergeNode_1007 = getElementType("hub.top.lang.flowcharts.diagram.MergeNode_1007"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType Flow_1008 = getElementType("hub.top.lang.flowcharts.diagram.Flow_1008"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType TransientResource_1009 = getElementType("hub.top.lang.flowcharts.diagram.TransientResource_1009"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType Document_1010 = getElementType("hub.top.lang.flowcharts.diagram.Document_1010"); //$NON-NLS-1$
  /**
   * @generated
   */
  public static final IElementType PersistentResource_1011 = getElementType("hub.top.lang.flowcharts.diagram.PersistentResource_1011"); //$NON-NLS-1$
  /**
   * @generated
   */
   ...
   * @generated
   */
  public static final IElementType DiagramArc_3001 = getElementType("hub.top.lang.flowcharts.diagram.DiagramArc_3001"); //$NON-NLS-1$
  ...
  public static ENamedElement getElement(IAdaptable hint) {
    ...
    if (elements == null) {
      ...
      elements.put(WorkflowDiagram_79, FlowPackage.eINSTANCE
          .getWorkflowDiagram());

      elements.put(StartNode_1001, FlowPackage.eINSTANCE.getStartNode());

      elements.put(Endnode_1002, FlowPackage.eINSTANCE.getEndnode());

      elements.put(SimpleActivity_1003, FlowPackage.eINSTANCE
          .getSimpleActivity());

      elements.put(Subprocess_1004, FlowPackage.eINSTANCE.getSubprocess());

      elements.put(Event_1005, FlowPackage.eINSTANCE.getEvent());

      elements.put(SplitNode_1006, FlowPackage.eINSTANCE.getSplitNode());

      elements.put(MergeNode_1007, FlowPackage.eINSTANCE.getMergeNode());

      elements.put(Flow_1008, FlowPackage.eINSTANCE.getFlow());

      elements.put(TransientResource_1009, FlowPackage.eINSTANCE
          .getTransientResource());

      elements.put(Document_1010, FlowPackage.eINSTANCE.getDocument());

      elements.put(PersistentResource_1011, FlowPackage.eINSTANCE
      ...
      elements.put(DiagramArc_3001, FlowPackage.eINSTANCE.getDiagramArc());
    }
  ...
  public static boolean isKnownElementType(IElementType elementType) {
    if (KNOWN_ELEMENT_TYPES == null) {
      ...
      KNOWN_ELEMENT_TYPES.add(WorkflowDiagram_79);
      KNOWN_ELEMENT_TYPES.add(StartNode_1001);
      KNOWN_ELEMENT_TYPES.add(Endnode_1002);
      KNOWN_ELEMENT_TYPES.add(SimpleActivity_1003);
      KNOWN_ELEMENT_TYPES.add(Subprocess_1004);
      KNOWN_ELEMENT_TYPES.add(Event_1005);
      KNOWN_ELEMENT_TYPES.add(SplitNode_1006);
      KNOWN_ELEMENT_TYPES.add(MergeNode_1007);
      KNOWN_ELEMENT_TYPES.add(Flow_1008);
      KNOWN_ELEMENT_TYPES.add(TransientResource_1009);
      KNOWN_ELEMENT_TYPES.add(Document_1010);
      KNOWN_ELEMENT_TYPES.add(PersistentResource_1011);
      ...
      KNOWN_ELEMENT_TYPES.add(DiagramArc_3001);
    }
