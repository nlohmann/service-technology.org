 ...
 * @generated
 */
public class Endnode2ViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = FlowchartVisualIDRegistry
          .getType(Endnode2EditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        FlowchartVisualIDRegistry.getType(EndnodeLabel2EditPart.VISUAL_ID),
