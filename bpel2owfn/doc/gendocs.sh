...
#
# NOTE:
#   This file has been edited by Niels Lohmann (nlohmann@informatik.hu-berlin.de)
#   to acheive compatibility with Cygwin. Changes are around line 160.
...
# Change by Niels Lohmann:
#  override variable definition to acheive compatiblity with Cygwin
srcfile=$PACKAGE.texi
