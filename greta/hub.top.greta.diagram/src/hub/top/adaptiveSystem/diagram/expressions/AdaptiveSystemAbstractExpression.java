 ...
 * @generated
 */
public abstract class AdaptiveSystemAbstractExpression {
	/**
	 * @generated
	 */
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(AdaptiveSystemDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected AdaptiveSystemAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	protected AdaptiveSystemAbstractExpression(String body, EClassifier context) {
		this.body = body;
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = AdaptiveSystemDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	public static final AdaptiveSystemAbstractExpression createNullExpression(
			EClassifier context) {
		return new AdaptiveSystemAbstractExpression(context) {
