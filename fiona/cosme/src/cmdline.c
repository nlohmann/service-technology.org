...
const char *gengetopt_args_info_purpose = "Cosme (Check Operating Guidelines for Simulation, Matching and Equivalence) is \na tool for 3-bit Operating Guidelines.";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [OPTIONS]...";

const char *gengetopt_args_info_description = "About Cosme:";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nInput/Output:",
  "  -a, --OGA=FILENAME           Input file for first Operating Guideline \n                                 (smaller one). ",
  "  -b, --OGB=FILENAME           Input file for second Operating Guideline \n                                 (assumed bigger one). ",
  "  -c, --ServiceC=FILENAME      Input file for service. ",
  "  -r, --resultFile[=FILENAME]  Results output.",
  "\nTasks:",
  "      --matching               Check matching for given Service and Operating \n                                 Guideline.  (default=off)",
  "      --simulation             Check simulation for given Operating Guidelines. \n                                  (default=off)",
  "      --equivalence            Check equivalence for given Operating \n                                 Guidelines.  (default=off)",
  "\nConfiguration:",
  "  Cosme relies on several other tools. These options configure Cosme to find \n  these tools.\n",
  ...
  "  The filename Cosme should use to create temporary files (i.e., the \n  intermediate Petri net passed to LoLA).\n",
  "      --noClean                Do not delete temporary files.  (default=off)",
  "  Any temporary files created by Cosme is kept after Cosme terminates.\n",
  "\nDebugging:",
  "  These options control how much debug output Cosme creates. The more debug \n  output is used, the slower Cosme runs.\n",
  "  -v, --verbose                Show verbose messages.  (default=off)",
  "  Show verbose information on the several intermediate steps. Note this option \n  might slow down the execution.\n",
  "      --finalize               Release all allocated memory.  (default=off)",
  "  This option calls the destructors of all objects that have been created by \n  Cosme. This is usually not necessary, because the operating system cleans up \n  once Cosme terminates. However, this option can be used to detect memory \n  leaks.\n",
  "      --stats                  Disply time and memory consumption on \n                                 termination.  (default=off)",
  "  The time is measured using the function clock(3). The memory usage is \n  measured using ps(1) command. Note that memory consumption contains a small \n  overhead.\n",
    0
};
static void
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[19] = gengetopt_args_info_detailed_help[22];
  gengetopt_args_info_full_help[20] = gengetopt_args_info_detailed_help[23];
  ...
  gengetopt_args_info_full_help[23] = 0; 
  
}

const char *gengetopt_args_info_full_help[24];
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->OGA_given = 0 ;
  args_info->OGB_given = 0 ;
  args_info->ServiceC_given = 0 ;
  args_info->resultFile_given = 0 ;
  args_info->matching_given = 0 ;
  args_info->simulation_given = 0 ;
  args_info->equivalence_given = 0 ;
  args_info->lola_given = 0 ;
  args_info->tmpfile_given = 0 ;
  args_info->noClean_given = 0 ;
  args_info->verbose_given = 0 ;
  args_info->finalize_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->OGA_arg = NULL;
  args_info->OGA_orig = NULL;
  args_info->OGB_arg = NULL;
  args_info->OGB_orig = NULL;
  args_info->ServiceC_arg = NULL;
  args_info->ServiceC_orig = NULL;
  args_info->resultFile_arg = NULL;
  args_info->resultFile_orig = NULL;
  args_info->matching_flag = 0;
  args_info->simulation_flag = 0;
  args_info->equivalence_flag = 0;
  args_info->lola_arg = gengetopt_strdup ("lola-statespace");
  args_info->lola_orig = NULL;
  args_info->tmpfile_arg = gengetopt_strdup ("/tmp/cosme-myFile.graph");
  args_info->tmpfile_orig = NULL;
  args_info->noClean_flag = 0;
  args_info->verbose_flag = 0;
  args_info->finalize_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->OGA_help = gengetopt_args_info_detailed_help[5] ;
  args_info->OGB_help = gengetopt_args_info_detailed_help[6] ;
  args_info->ServiceC_help = gengetopt_args_info_detailed_help[7] ;
  args_info->resultFile_help = gengetopt_args_info_detailed_help[8] ;
  args_info->matching_help = gengetopt_args_info_detailed_help[10] ;
  args_info->simulation_help = gengetopt_args_info_detailed_help[11] ;
  args_info->equivalence_help = gengetopt_args_info_detailed_help[12] ;
  args_info->lola_help = gengetopt_args_info_detailed_help[15] ;
  args_info->tmpfile_help = gengetopt_args_info_detailed_help[17] ;
  args_info->noClean_help = gengetopt_args_info_detailed_help[19] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[23] ;
  args_info->finalize_help = gengetopt_args_info_detailed_help[25] ;
  args_info->stats_help = gengetopt_args_info_detailed_help[27] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->OGA_arg));
  free_string_field (&(args_info->OGA_orig));
  free_string_field (&(args_info->OGB_arg));
  free_string_field (&(args_info->OGB_orig));
  free_string_field (&(args_info->ServiceC_arg));
  free_string_field (&(args_info->ServiceC_orig));
  free_string_field (&(args_info->resultFile_arg));
  free_string_field (&(args_info->resultFile_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->OGA_given)
    write_into_file(outfile, "OGA", args_info->OGA_orig, 0);
  if (args_info->OGB_given)
    write_into_file(outfile, "OGB", args_info->OGB_orig, 0);
  if (args_info->ServiceC_given)
    write_into_file(outfile, "ServiceC", args_info->ServiceC_orig, 0);
  if (args_info->resultFile_given)
    write_into_file(outfile, "resultFile", args_info->resultFile_orig, 0);
  if (args_info->matching_given)
    write_into_file(outfile, "matching", 0, 0 );
  if (args_info->simulation_given)
    write_into_file(outfile, "simulation", 0, 0 );
  if (args_info->equivalence_given)
    write_into_file(outfile, "equivalence", 0, 0 );
  ...
  if (args_info->finalize_given)
    write_into_file(outfile, "finalize", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->OGA_given)
    {
      fprintf (stderr, "%s: '--OGA' ('-a') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVa:b:c:r::v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* Input file for first Operating Guideline (smaller one). .  */
        
        
          if (update_arg( (void *)&(args_info->OGA_arg), 
               &(args_info->OGA_orig), &(args_info->OGA_given),
              &(local_args_info.OGA_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 'b':	/* Input file for second Operating Guideline (assumed bigger one). .  */
        
        
          if (update_arg( (void *)&(args_info->OGB_arg), 
               &(args_info->OGB_orig), &(args_info->OGB_given),
              &(local_args_info.OGB_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "OGB", 'b',
              additional_error))
            goto failure;
          ...
          break;
        case 'c':	/* Input file for service. .  */
        
        
          if (update_arg( (void *)&(args_info->ServiceC_arg), 
               &(args_info->ServiceC_orig), &(args_info->ServiceC_given),
              &(local_args_info.ServiceC_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "ServiceC", 'c',
              additional_error))
            goto failure;
        ...
        case 'r':	/* Results output..  */
          ...
          if (update_arg( (void *)&(args_info->resultFile_arg), 
               &(args_info->resultFile_orig), &(args_info->resultFile_given),
              &(local_args_info.resultFile_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "resultFile", 'r',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "matching") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->matching_flag), 0, &(args_info->matching_given),
                &(local_args_info.matching_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "matching", '-',
                additional_error))
              goto failure;
          
          }
          /* Check simulation for given Operating Guidelines..  */
          else if (strcmp (long_options[option_index].name, "simulation") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->simulation_flag), 0, &(args_info->simulation_given),
                &(local_args_info.simulation_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "simulation", '-',
                additional_error))
              goto failure;
          
          }
          /* Check equivalence for given Operating Guidelines..  */
          else if (strcmp (long_options[option_index].name, "equivalence") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->equivalence_flag), 0, &(args_info->equivalence_given),
                &(local_args_info.equivalence_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "equivalence", '-',
                additional_error))
              goto failure;
          
          }
          /* Set the path and binary of LoLA..  */
          else if (strcmp (long_options[option_index].name, "lola") == 0)
          {
          ...
          else if (strcmp (long_options[option_index].name, "tmpfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->tmpfile_arg), 
                ...
                &(local_args_info.tmpfile_given), optarg, 0, "/tmp/cosme-myFile.graph", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "tmpfile", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "finalize") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->finalize_flag), 0, &(args_info->finalize_given),
                &(local_args_info.finalize_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "finalize", '-',
                additional_error))
              goto failure;
