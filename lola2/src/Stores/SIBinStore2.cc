...
SIBinStore2::SIBinStore2(int threadnum)  : SIStore(threadnum)
{
...
SIBinStore2::Decision::Decision(bitindex_t b) : bit(b) , nextold(NULL), nextnew(NULL), state(0)
{
}
...
uint64_t SIBinStore2::search(int threadNumber)
{
