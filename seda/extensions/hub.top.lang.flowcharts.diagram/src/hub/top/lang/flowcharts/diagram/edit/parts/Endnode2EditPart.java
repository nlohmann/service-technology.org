...
import hub.top.lang.flowcharts.diagram.edit.policies.Endnode2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Endnode2EditPart extends ShapeNodeEditPart {
   ...
   * @generated
   */
  public Endnode2EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new Endnode2ItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof EndnodeLabel2EditPart) {
      ((EndnodeLabel2EditPart) childEditPart).setLabel(getPrimaryShape()
