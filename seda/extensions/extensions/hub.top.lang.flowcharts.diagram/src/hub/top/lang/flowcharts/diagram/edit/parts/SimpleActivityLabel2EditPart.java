 ...
 * @generated
 */
public class SimpleActivityLabel2EditPart extends CompartmentEditPart implements
    ITextAwareEditPart {
   ...
   * @generated
   */
  public SimpleActivityLabel2EditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new FlowchartParserProvider.HintAdapter(
          FlowchartElementTypes.SimpleActivity_2003, getParserElement(),
          parserHint);
