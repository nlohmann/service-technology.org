 ...
 * @generated
 */
public class PtNetCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator
					.hasNext();) {
				hub.top.editor.ptnetLoLA.diagram.part.PtnetLoLALinkDescriptor nextLinkDescriptor = (hub.top.editor.ptnetLoLA.diagram.part.PtnetLoLALinkDescriptor) LinkDescriptorsIterator
						.next();
