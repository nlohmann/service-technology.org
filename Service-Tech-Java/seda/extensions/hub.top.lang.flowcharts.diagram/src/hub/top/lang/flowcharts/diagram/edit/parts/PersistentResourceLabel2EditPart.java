 ...
 * @generated
 */
public class PersistentResourceLabel2EditPart extends CompartmentEditPart
   ...
   * @generated
   */
  public PersistentResourceLabel2EditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new FlowchartParserProvider.HintAdapter(
          FlowchartElementTypes.PersistentResource_3011, getParserElement(),
          parserHint);
