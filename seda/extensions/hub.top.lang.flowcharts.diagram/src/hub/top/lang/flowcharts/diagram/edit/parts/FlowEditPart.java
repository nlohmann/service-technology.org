...
import hub.top.lang.flowcharts.diagram.edit.policies.FlowItemSemanticEditPolicy;
...
public class FlowEditPart extends ShapeNodeEditPart {
  ...
  public void activate() {
    ...
    parentFigure.addLayoutListener(new LayoutListener.Stub() {
      ...
      public void postLayout(IFigure hostFigure) {
        ...
        if (FlowEditPart.this.getChildren().size() > 0) {
          FlowFlowCompartmentEditPart ffce = (FlowFlowCompartmentEditPart) FlowEditPart.this
              .getChildren().get(0);
        ...
        TransactionalEditingDomain editingDomain = FlowEditPart.this
            .getEditingDomain();

        SetBoundsCommand c = new SetBoundsCommand(editingDomain,
            DiagramUIMessages.SetAutoSizeCommand_Label, FlowEditPart.this,
            new Rectangle(newLocation, newSize));
        FlowEditPart.this.getViewer().getEditDomain().getCommandStack()
  ...
  protected boolean removeFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof FlowFlowCompartmentEditPart) {
      IFigure pane = getPrimaryShape().getFigureFlowFigure2Pane();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
      pane.remove(((FlowFlowCompartmentEditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
