...
import hub.top.editor.lola.text.prettyprinting.PrettyPrinterOpenNet;
...
public class ModelEditorON extends hub.sam.tef.editor.model.ModelEditor implements hub.top.editor.eclipse.IFrameWorkEditor {
	...
	public PrettyPrinter createPrettyPrinter(Syntax syntax,
		...
		return new PrettyPrinterOpenNet(syntax, semanticsProvider);
	}
	...
	public EditorUtil getEditorUtil() {
		return new EditorUtil(this) {
			...
			public String getCurrentText() {
				return ((ModelEditorON)getEditor()).getCurrentText();
			}
