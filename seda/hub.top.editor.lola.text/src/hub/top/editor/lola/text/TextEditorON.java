...
public class TextEditorON extends hub.sam.tef.editor.text.TextEditor implements hub.top.editor.eclipse.IFrameWorkEditor {
	...
	public EditorUtil getEditorUtil () {
		return new EditorUtil(this) {
			...
			public Resource getCurrentResource() {
				return ((TextEditorON)getEditor()).getCurrentModel();
			}
