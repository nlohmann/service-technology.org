 ...
 * @generated
 */
public class Flow2ViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = FlowchartVisualIDRegistry.getType(Flow2EditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        FlowchartVisualIDRegistry
            .getType(FlowFlowCompartment2EditPart.VISUAL_ID), ViewUtil.APPEND,
