...
import hub.top.editor.ptnetLoLA.PlaceReference;
...
public class PtnetLoLAPackageImpl extends EPackageImpl implements PtnetLoLAPackage {
   ...
   * @see hub.top.editor.ptnetLoLA.PtnetLoLAPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
    ...
    PtnetLoLAPackageImpl thePtnetLoLAPackage = (PtnetLoLAPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof PtnetLoLAPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new PtnetLoLAPackageImpl());
   ...
   */
    ...
    initEAttribute(getTransitionExt_Probability(), ecorePackage.getEDouble(), "probability", null, 0, 1, TransitionExt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(placeExtEClass, PlaceExt.class, "PlaceExt", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPlaceExt_Probability(), ecorePackage.getEDouble(), "probability", null, 0, 1, PlaceExt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(arcToPlaceExtEClass, ArcToPlaceExt.class, "ArcToPlaceExt", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getArcToPlaceExt_Probability(), ecorePackage.getEDouble(), "probability", null, 0, 1, ArcToPlaceExt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getArcToTransitionExt_Probability(), ecorePackage.getEDouble(), "probability", null, 0, 1, ArcToTransitionExt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
