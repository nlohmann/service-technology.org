 ...
 * @generated
 */
public class DiagramArcProbabilityEditPart extends LabelEditPart implements
    ITextAwareEditPart {
  ...
  static {
    registerSnapBackPosition(
        FlowchartVisualIDRegistry
            .getType(hub.top.lang.flowcharts.diagram.edit.parts.DiagramArcProbabilityEditPart.VISUAL_ID),
        new Point(7, 7));
  }
   ...
   * @generated
   */
  public DiagramArcProbabilityEditPart(View view) {
    super(view);
  }
  ...
  protected String getLabelText() {
    ...
    //// <Dirk.F>
    if (text.equals("1"))
      return "";    // return nothing in case of default value
    //// </Dirk.F>
    return text;
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new FlowchartParserProvider.HintAdapter(
          FlowchartElementTypes.DiagramArc_4001, getParserElement(), parserHint);
