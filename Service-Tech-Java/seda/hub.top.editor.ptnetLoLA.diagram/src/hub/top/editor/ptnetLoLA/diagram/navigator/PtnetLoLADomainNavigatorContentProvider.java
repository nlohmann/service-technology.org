 ...
 * @generated
 */
public class PtnetLoLADomainNavigatorContentProvider implements
   ...
   * @generated
   */
  public PtnetLoLADomainNavigatorContentProvider() {
  ...
  public Object[] getChildren(Object parentElement) {
    ...
    if (parentElement instanceof hub.top.editor.ptnetLoLA.diagram.navigator.PtnetLoLADomainNavigatorItem) {
      return wrapEObjects(
          myAdapterFctoryContentProvier.getChildren(((hub.top.editor.ptnetLoLA.diagram.navigator.PtnetLoLADomainNavigatorItem) parentElement)
  ...
  public Object[] wrapEObjects(Object[] objects, Object parentElement) {
    ...
    for (int i = 0; i < objects.length; i++) {
      if (objects[i] instanceof EObject) {
        result
            .add(new hub.top.editor.ptnetLoLA.diagram.navigator.PtnetLoLADomainNavigatorItem(
