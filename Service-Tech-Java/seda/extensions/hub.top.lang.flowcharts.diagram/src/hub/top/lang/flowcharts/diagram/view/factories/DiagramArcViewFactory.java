 ...
 * @generated
 */
public class DiagramArcViewFactory extends ConnectionViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = FlowchartVisualIDRegistry
          .getType(DiagramArcEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        FlowchartVisualIDRegistry
            .getType(DiagramArcProbabilityEditPart.VISUAL_ID), ViewUtil.APPEND,
