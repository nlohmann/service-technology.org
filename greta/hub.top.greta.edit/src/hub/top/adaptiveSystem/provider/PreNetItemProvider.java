...
/**
 * This is the item provider adapter for a {@link hub.top.adaptiveSystem.PreNet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PreNetItemProvider
	 ...
	 * @generated
	 */
	public PreNetItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PreNet_markedConditions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PreNet_markedConditions_feature", "_UI_PreNet_type"),
				 AdaptiveSystemPackage.Literals.PRE_NET__MARKED_CONDITIONS,
				 false,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PreNet"));
	}
	...
	public String getText(Object object) {
		String label = ((PreNet)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PreNet_type") :
			getString("_UI_PreNet_type") + " " + label;
	}
