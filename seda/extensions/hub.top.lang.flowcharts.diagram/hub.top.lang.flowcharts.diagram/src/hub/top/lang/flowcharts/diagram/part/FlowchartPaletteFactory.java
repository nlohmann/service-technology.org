...
public class FlowchartPaletteFactory {
  ...
  private ToolEntry createStartNode1CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.StartNode_1001));
  ...
  private ToolEntry createEndnode2CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.Endnode_1002));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createSplitNode3CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.SplitNode_1006));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createMergeNode4CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.MergeNode_1007));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createFlow5CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.Flow_1008));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createSimpleActivity6CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.SimpleActivity_1003));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createPersistentResource7CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.PersistentResource_2011));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createTransientResource8CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.TransientResource_2009));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createDocument9CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.Document_2010));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
  ...
  private ToolEntry createEvent10CreationTool() {
    ...
    entry.setSmallIcon(FlowchartElementTypes
        .getImageDescriptor(FlowchartElementTypes.Event_1005));
    entry.setLargeIcon(entry.getSmallIcon());
    return entry;
  }
