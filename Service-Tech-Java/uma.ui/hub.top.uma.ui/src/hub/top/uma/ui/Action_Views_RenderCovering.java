...
public class Action_Views_RenderCovering implements IWorkbenchWindowActionDelegate {

	public static final String ID = "hub.top.uma.ui.view.RenderCovering";
      ...
      Job bpBuildJob = new Job("constructing view") 
      {
        ...
        protected IStatus run(IProgressMonitor monitor) {
            ...
            for (Entry<DNode, Float> coverVal : cover.entrySet()) {
              if (coverVal.getValue() > 0) {
                String colorString;
                colorString = "grey"+(int)((1-coverVal.getValue())*80);
                colorMap.put(coverVal.getKey(), colorString);
              }
            }

            IPath targetPath_dot = new Path(selectedFile_system.getFullPath().toString()+".covered_bp.dot");
