...
case $COVER in
  "ZCOV")
    ...
    ZCOV="/home/jeed/workspace/safira/tests/zcov/zcov-scan"
    ...
    # scan directory
    $ZCOV /home/jeed/workspace/safira/tests/cover/$TESTNAME.zcov /home/jeed/workspace/safira &> /dev/null
  ...
  "LCOV")
    ...
    LCOV="/home/jeed/workspace/safira/tests/lcov/lcov --quiet"
    ...
    dir=`pwd`
    TESTNAME=`basename $dir`
    INFOFILE=/home/jeed/workspace/safira/tests/cover/$TESTNAME-$RANDOM.info

    # reset counters for LCOV
    $LCOV --zerocounters -directory /home/jeed/workspace/safira
    ...
    $LCOV --capture --directory /home/jeed/workspace/safira --output-file $INFOFILE --test-name $TESTNAME

    # remove profile information on C++ sources and headers
    $LCOV --extract $INFOFILE "/home/jeed/workspace/safira/*" -o $INFOFILE
