      ...
      if (Boolean.TYPE.equals(iClass)) {
        if (value instanceof Boolean) {
          ...
          value = new InvalidValue(
              NLS.bind(
                  hub.top.editor.ptnetLoLA.diagram.part.Messages.AbstractParser_UnexpectedValueType,
                  iClass.getName()));
        }
        ...
        if (value instanceof Byte) {
          ...
          if (s.length() == 0) {
            ...
            try {
              ...
              value = new InvalidValue(
                  NLS.bind(
                      hub.top.editor.ptnetLoLA.diagram.part.Messages.AbstractParser_WrongStringConversion,
                      iClass.getName()));
            }
          }
        } else {
        ...
        if (value instanceof String) {
          ...
          if (literal == null) {
            value = new InvalidValue(
                NLS.bind(
                    hub.top.editor.ptnetLoLA.diagram.part.Messages.AbstractParser_UnknownLiteral,
                    value));
          } else {
