...
bool testtdevdbi(bool silent)
{
    ...
    waserrors = valerr>threshold||vecerr>threshold||wnsorted||wfailed||wspecialf;
    if( !silent )
    {
...
bool testtdevdbiunit_test_silent()
{
    ...
    return result;
#else
    return _i_testtdevdbiunit_test_silent();
#endif
}
...
bool testtdevdbiunit_test()
{
    ...
    return result;
#else
    return _i_testtdevdbiunit_test();
#endif
}
