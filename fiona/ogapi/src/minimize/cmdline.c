/*
  ...
  gengetopt --input=cmdline.ggo --include-getopt --show-required --unamed-opts=FILE --no-handle-error --conf-parser
...
const char *gengetopt_args_info_purpose = "This tool is made for minimizing operating guidelines.";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [OPTIONS]... [FILE]...";

const char *gengetopt_args_info_description = "About:";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nInput/Output:",
  "  -o, --output[=FILENAME]  Specifying output filename.",
  "\nDebugging:",
  "  -v, --verbose            Show verbose messages.  (default=off)",
  "  Show verbose messages reporting intermediate steps.",
  "      --bug                Write configuration information into a file \n                             `bug.log'.  (default=off)",
  "  This output file gives information on the machine Minimize was configured and \n  compiled which should help to fix bugs. The file `bug.log' should be attached \n  to bug reports.\n",
  "      --tmpfile=FILENAME   Set the path and name of temporary files  \n                             (default=`/tmp/minimize-XXXXXX')",
  "  The filename Minimize should use to create temporary files. The filename \n  should end with `XXXXXX' which is replaced at runtime with a random string.\n",
  "      --noClean            Do not delete temporary files.  (default=off)",
  "  Any temporary files created by Minimize is kept after Minimize terminates.\n",
    0
};
static void
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[8] = gengetopt_args_info_detailed_help[13];
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->tmpfile_arg = gengetopt_strdup ("/tmp/minimize-XXXXXX");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->bug_help = gengetopt_args_info_detailed_help[9] ;
  args_info->tmpfile_help = gengetopt_args_info_detailed_help[11] ;
  args_info->noClean_help = gengetopt_args_info_detailed_help[13] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVo::v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'o':	/* Specifying output filename..  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "bug") == 0)
          {
          ...
          else if (strcmp (long_options[option_index].name, "tmpfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->tmpfile_arg), 
                ...
                &(local_args_info.tmpfile_given), optarg, 0, "/tmp/minimize-XXXXXX", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "tmpfile", '-',
                additional_error))
              goto failure;
