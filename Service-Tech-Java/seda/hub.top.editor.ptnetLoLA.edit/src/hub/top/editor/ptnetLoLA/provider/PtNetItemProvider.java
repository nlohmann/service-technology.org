...
public class PtNetItemProvider
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PtnetLoLAPackage.Literals.PT_NET__PLACES,
				 PtnetLoLAFactory.eINSTANCE.createPlaceExt()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PtnetLoLAPackage.Literals.PT_NET__TRANSITIONS,
				 PtnetLoLAFactory.eINSTANCE.createTransitionExt()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PtnetLoLAPackage.Literals.PT_NET__ARCS,
				 PtnetLoLAFactory.eINSTANCE.createArcToPlaceExt()));

		newChildDescriptors.add
			(createChildParameter
				(PtnetLoLAPackage.Literals.PT_NET__ARCS,
				 PtnetLoLAFactory.eINSTANCE.createArcToTransitionExt()));
