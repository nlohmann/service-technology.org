...
#define yyparse pnapi_pnml_yyparse
#define yylex   pnapi_pnml_yylex
#define yyerror pnapi_pnml_yyerror
#define yylval  pnapi_pnml_yylval
#define yychar  pnapi_pnml_yychar
#define yydebug pnapi_pnml_yydebug
#define yynerrs pnapi_pnml_yynerrs
...
#endif
/* Tokens.  */
#define XML_ENDDEF 258
#define XML_EQ 259
#define XML_SLASH 260
#define XML_CLOSE 261
#define XML_END 262
#define XML_NAME 263
#define XML_VALUE 264
#define XML_DATA 265
#define XML_START 266




/* Copy the first part of user declarations.  */
#line 20 "parser-pnml.yy"
...
#line 307 "parser-pnml.yy"
{char *s;}
/* Line 187 of yacc.c.  */
#line 410 "parser-pnml.cc"
	YYSTYPE;
...
{
      13,     0,    -1,    -1,    11,    14,    18,    15,    -1,     5,
       6,    -1,     6,    16,     7,    17,     6,    -1,    16,    10,
      -1,    16,    13,    -1,    -1,     8,    -1,    -1,    18,    19,
      -1,    -1,     8,    -1,     8,     4,     9,    -1
};
...
{
       0,   320,   320,   320,   324,   325,   328,   329,   330,   333,
     334,   337,   338,   341,   342
};
#endif
...
{
  "$end", "error", "$undefined", "XML_ENDDEF", "XML_EQ", "XML_SLASH",
  "XML_CLOSE", "XML_END", "XML_NAME", "XML_VALUE", "XML_DATA", "XML_START",
  "$accept", "element", "@1", "empty_or_content", "content", "name_opt",
...
{
       0,     2,     0,    12,     1,     0,     0,     8,    13,     3,
      11,     4,     0,     0,    10,     6,     7,    14,     9,     0,
       5
};
...
{
     -10,   -11,     2,   -11,   -11,     0,     1,   -11,     5,   -11,
     -11,   -11,    -7,     3,     6,   -11,   -11,   -11,   -11,     4,
     -11
};
...
{
      14,     1,     4,    15,     1,     6,     7,    11,     8,    13,
      20,    16,    17,     0,    18
};

static const yytype_int8 yycheck[] =
{
       7,    11,     0,    10,    11,     5,     6,     6,     8,     4,
       6,    12,     9,    -1,     8
};
...
{
       0,    11,    13,    14,     0,    18,     5,     6,     8,    15,
      19,     6,    16,     4,     7,    10,    13,     9,     8,    17,
       6
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 320 "parser-pnml.yy"
    {open_element((yyvsp[(1) - (1)].s)); free((yyvsp[(1) - (1)].s));}
    break;

  case 4:
#line 324 "parser-pnml.yy"
    {close_element();}
    break;

  case 5:
#line 325 "parser-pnml.yy"
    {close_element();}
    break;

  case 6:
#line 328 "parser-pnml.yy"
    {store_data((yyvsp[(2) - (2)].s));}
    break;

  case 9:
#line 333 "parser-pnml.yy"
    {(yyval.s) = (yyvsp[(1) - (1)].s);}
    break;

  case 10:
#line 334 "parser-pnml.yy"
    {(yyval.s) = strdup("");}
    break;

  case 13:
#line 341 "parser-pnml.yy"
    {free((yyvsp[(1) - (1)].s));}
    break;

  case 14:
#line 342 "parser-pnml.yy"
    {store_attributes((yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s)); free((yyvsp[(1) - (3)].s)); free((yyvsp[(3) - (3)].s));}
    break;


/* Line 1267 of yacc.c.  */
#line 1661 "parser-pnml.cc"
      default: break;
    }
