 ...
 * \since   2005/10/18
 *
 * \date    $Date: 2009-10-02 11:31:45 +0200 (Fr, 02. Okt 2009) $
 *
...
public:
  ...
  static void setPetrify(std::string = CONFIG_PETRIFY);

  /// setting path to Genet
  static void setGenet(std::string = CONFIG_GENET, uint8_t = 2);
