...
class Node
{
  ...
  public:
    ...
    /// set containing the information about this places swimlane in IBM BOM
    set<string> roles;
  ...
  protected:
    ...
    /// true if history contains role with the given substring
    bool historyContainsSubString(string substring) const;
...
class Place: public Node
{
  ...
  public:
    ...
    // gives back true if at least one token is on this place
    bool marked();
};
...
class PetriNet
{
  ...
  public:
    ...
    // remove places, transition and recreate Interface according to the given roles and mode
    void cutByRoles();
    ...
    unsigned int fix_lola_output();

    /// merges two places
    Place* mergePlaces(Place * & p1, Place * & p2);

    /// merges two places
    Place* mergePlaces(string role1, Place * & p2);

    /// merges two places
    Place* mergePlaces(Place * & p1, string role2);
    ...
    Place* mergePlaces(unsigned int id1, string role1, unsigned int id2, string role2);
    ...
    /// returns a set of all internal places
    set<Place *> getInternalPlaces() const;
