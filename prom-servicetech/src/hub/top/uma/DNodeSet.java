...
public class DNodeSet {
   ...
   * or {@link DNodeSet#fire(DNode[], DNode[])} is called. 
	 ...
	 */
//	HV: Used in DNodeBP and DNode2Petrinet. Why deprecated if used? If deprecated, use an alternative in DNodeBP and DNode2Petrinet.
//	@Deprecated
   ...
   */
	 ...
	 *  {@link DNodeSet#getPrimeCut(DNode, hub.top.unfold.DNode.SortedLinearList)}
