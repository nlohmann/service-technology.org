 ...
 * @generated
 */
public class SplitNode2ViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = FlowchartVisualIDRegistry
          .getType(SplitNode2EditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        FlowchartVisualIDRegistry.getType(SplitNodeLabel2EditPart.VISUAL_ID),
