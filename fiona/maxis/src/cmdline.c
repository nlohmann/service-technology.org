/*
  ...
  gengetopt --input=cmdline.ggo --unamed-opts=FILES --include-getopt --show-required --no-handle-error
...
const char *gengetopt_args_info_purpose = "Generating a Maximal Partner from an Operating Guideline for Services";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [OPTIONS]... [FILES]...";

const char *gengetopt_args_info_description = "About Maxis:";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nInput / Output:",
  "  -o, --output=OUTFILE   Output file. If no file is given, it will be written \n                           to standard out.",
  "      --ignoreEmptyNode  Nodes with ID '0' will be ignored. For evaluation \n                           purpose only.  (default=off)",
  "      --show-states      State of input OGs will be noted at each state  \n                           (default=off)",
  "\n Group: Options\n  These options control how a maximal partner is calculated.\n",
  "  -l, --liberal[=MODE]   Calculate a set of satisfiable assignments for each \n                           Boolean formula:\n                           0 - as stated in the input file \n                           1 - the least liberal (minimum)\n                           2 - the most liberal (maximum)\n                             (possible values=\"0\", \"1\", \"2\" default=`0')",
  "\nDebugging:",
  "  These options control how much debug output the compilers create.\n",
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[13] = 0; 
  
}

const char *gengetopt_args_info_full_help[14];
...
const char *cmdline_parser_liberal_values[] = {"0", "1", "2", 0}; /*< Possible values for liberal. */
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignoreEmptyNode_given = 0 ;
  args_info->show_states_given = 0 ;
  args_info->liberal_given = 0 ;
  args_info->verbose_given = 0 ;
  args_info->Options_group_counter = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignoreEmptyNode_flag = 0;
  args_info->show_states_flag = 0;
  args_info->liberal_arg = liberal_arg_0;
  args_info->liberal_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignoreEmptyNode_help = gengetopt_args_info_detailed_help[6] ;
  args_info->show_states_help = gengetopt_args_info_detailed_help[7] ;
  args_info->liberal_help = gengetopt_args_info_detailed_help[9] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->liberal_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ignoreEmptyNode_given)
    write_into_file(outfile, "ignoreEmptyNode", 0, 0 );
  if (args_info->show_states_given)
    write_into_file(outfile, "show-states", 0, 0 );
  if (args_info->liberal_given)
    write_into_file(outfile, "liberal", args_info->liberal_orig, cmdline_parser_liberal_values);
...
static void
reset_group_Options(struct gengetopt_args_info *args_info)
{
  if (! args_info->Options_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->Options_group_counter == 0)
    {
      fprintf (stderr, "%s: %d options of group Options were given. One is required%s.\n", prog_name, args_info->Options_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "version",	0, NULL, 'V' },
        { "output",	1, NULL, 'o' },
        { "ignoreEmptyNode",	0, NULL, 0 },
        { "show-states",	0, NULL, 0 },
        { "liberal",	2, NULL, 'l' },
        { "verbose",	0, NULL, 'v' },
        { 0,  0, 0, 0 }
      };
      ...
      c = custom_getopt_long (argc, argv, "hVo:l::v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'o':	/* Output file. If no file is given, it will be written to standard out..  */
          ...
          break;
        case 'l':	/* Calculate a set of satisfiable assignments for each Boolean formula:
        0 - as stated in the input file 
        1 - the least liberal (minimum)
        2 - the most liberal (maximum)\n.  */
        
          if (args_info->Options_group_counter && override)
            reset_group_Options (args_info);
          args_info->Options_group_counter += 1;
        
          if (update_arg( (void *)&(args_info->liberal_arg), 
               &(args_info->liberal_orig), &(args_info->liberal_given),
              &(local_args_info.liberal_given), optarg, cmdline_parser_liberal_values, "0", ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "liberal", 'l',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "ignoreEmptyNode") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->ignoreEmptyNode_flag), 0, &(args_info->ignoreEmptyNode_given),
                &(local_args_info.ignoreEmptyNode_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "ignoreEmptyNode", '-',
                additional_error))
              goto failure;
          
          }
          /* State of input OGs will be noted at each state.  */
          else if (strcmp (long_options[option_index].name, "show-states") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->show_states_flag), 0, &(args_info->show_states_given),
                &(local_args_info.show_states_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "show-states", '-',
                additional_error))
              goto failure;
  ...
  if (args_info->Options_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group Options were given. One is required%s.\n", argv[0], args_info->Options_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
