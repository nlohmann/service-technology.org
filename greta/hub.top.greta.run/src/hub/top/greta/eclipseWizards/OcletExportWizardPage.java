...
public class OcletExportWizardPage extends WizardPage implements Listener {
	...
	public OcletExportWizardPage(String pageName) {
		super(pageName);
	...
	public OcletExportWizardPage(String pageName, String title, ImageDescriptor titleImage) {
		...
		browseButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				try {
					...
					dialog.setFileName(getOutputFileName("oclets"));
					String []ext = new String[] { "*.oclets", "*.dot" }; 
