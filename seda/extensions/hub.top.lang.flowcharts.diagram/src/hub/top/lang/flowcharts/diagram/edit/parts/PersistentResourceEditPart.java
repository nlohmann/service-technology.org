...
import hub.top.lang.flowcharts.diagram.edit.policies.PersistentResourceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PersistentResourceEditPart extends ShapeNodeEditPart {
   ...
   * @generated
   */
  public PersistentResourceEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new PersistentResourceItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof PersistentResourceLabelEditPart) {
      ((PersistentResourceLabelEditPart) childEditPart)
