/*
  ...
  gengetopt --input=./configurator-cmdline.ggo --set-version=4.02-unreleased --file-name=configurator-cmdline --unamed-opts=FILES --include-getopt --show-required --no-handle-error
