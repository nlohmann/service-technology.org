...
public interface Place extends Node {
  ...
  /**
   * @return a list of all direct pre-transitions of this place
   */
  EList<Transition> getPreSet();

  /**
   * @return a list of all direct post-transitions of this place
   */
  EList<Transition> getPostSet();
} // Place
