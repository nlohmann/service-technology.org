...
import hub.top.lang.flowcharts.diagram.edit.policies.Document2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Document2EditPart extends ShapeNodeEditPart {
   ...
   * @generated
   */
  public Document2EditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
        new Document2ItemSemanticEditPolicy());
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof DocumentLabel2EditPart) {
      ((DocumentLabel2EditPart) childEditPart).setLabel(getPrimaryShape()
          .getFigureResourceNodeLabel());
      return true;
    }
    return false;
  }
