...
import hub.top.lang.flowcharts.diagram.edit.policies.DocumentItemSemanticEditPolicy;
...
public class DocumentEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof DocumentLabelEditPart) {
      ((DocumentLabelEditPart) childEditPart).setLabel(getPrimaryShape()
