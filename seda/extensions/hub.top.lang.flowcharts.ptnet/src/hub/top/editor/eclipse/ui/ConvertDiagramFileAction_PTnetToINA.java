...
public class ConvertDiagramFileAction_PTnetToINA extends ConvertDiagramFileAction {


	/**
	 * Create a {@link ConvertFileWizard_PTnetToINA} to convert a selected
	 * P/T net to an INA document.
	 * 
	...
	{
		ConvertFileWizard wizard = new ConvertFileWizard_PTnetToINA(
				srcURI, root, editingDomain, "pnt");
		wizard.setWindowTitle("Convert P/T-Net to INA file");
		return wizard;
	}
}
