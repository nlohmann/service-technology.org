/*
  ...
  gengetopt --include-getopt --show-required --unamed-opts=FILE --no-handle-error --conf-parser
...
const char *gengetopt_args_info_purpose = "Safira: Set Algebra for Service Behavior.";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [OPTIONS]... [FILE]...";

const char *gengetopt_args_info_description = "About Safira:";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  The filename Safira should use to create temporary files. The filename should \n  end with `XXXXXX' which is replaced at runtime with a random string.\n",
  "      --noClean            Do not delete temporary files.  (default=off)",
  "  Any temporary files created by Safira is kept after Safira terminates.\n",
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[9] = gengetopt_args_info_detailed_help[11];
...
const char *cmdline_parser_complement_values[] = {"0", "1", "2", 0}; /*< Possible values for complement. */
const char *cmdline_parser_output_values[] = {"eaa", "dot", "png", "pdf", "eps", "none", 0}; /*< Possible values for output. */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->clean_flag = 0;
  args_info->tmpfile_arg = gengetopt_strdup ("/tmp/safira-XXXXXX");
  args_info->tmpfile_orig = NULL;
  args_info->noClean_flag = 0;
  args_info->complement_arg = complement_arg_2;
  args_info->complement_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->verbose_help = gengetopt_args_info_detailed_help[4] ;
  args_info->clean_help = gengetopt_args_info_detailed_help[5] ;
  args_info->tmpfile_help = gengetopt_args_info_detailed_help[6] ;
  args_info->noClean_help = gengetopt_args_info_detailed_help[8] ;
  args_info->complement_help = gengetopt_args_info_detailed_help[11] ;
  args_info->intersection_help = gengetopt_args_info_detailed_help[12] ;
  args_info->union_help = gengetopt_args_info_detailed_help[13] ;
  args_info->output_help = gengetopt_args_info_detailed_help[16] ;
  args_info->output_min = 0;
  args_info->output_max = 0;
  args_info->time_help = gengetopt_args_info_detailed_help[17] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->complement_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->clean_given)
    write_into_file(outfile, "clean", 0, 0 );
  ...
  if (args_info->complement_given)
    write_into_file(outfile, "complement", args_info->complement_orig, cmdline_parser_complement_values);
  if (args_info->intersection_given)
    write_into_file(outfile, "intersection", 0, 0 );
...
static void
reset_group_operations(struct gengetopt_args_info *args_info)
{
  if (! args_info->operations_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->operations_group_counter == 0)
    {
      fprintf (stderr, "%s: %d options of group operations were given. One is required%s.\n", prog_name, args_info->operations_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvc::iuo:t", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'v':	/* Show verbose output.  */
          ...
          break;
        case 'c':	/* Complements a given extended annotated service automaton
        0 - unreduced result
        1 - simple reduction algorithm (slow)
        2 - efficient reduction algorithm (fast).  */
        
          if (args_info->operations_group_counter && override)
            reset_group_operations (args_info);
          args_info->operations_group_counter += 1;
        
          if (update_arg( (void *)&(args_info->complement_arg), 
               &(args_info->complement_orig), &(args_info->complement_given),
              &(local_args_info.complement_given), optarg, cmdline_parser_complement_values, "2", ARG_ENUM,
          ...
          break;
        case 'i':	/* Calculates the intersection for two given extended annotated service automata. Both automato must have the same interface!.  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->intersection_given),
              &(local_args_info.intersection_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "intersection", 'i',
              additional_error))
            goto failure;
          ...
          break;
        case 'u':	/* Calculates the union for two given extended annotated service automata.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "clean") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->clean_flag), 0, &(args_info->clean_given),
                &(local_args_info.clean_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "clean", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "tmpfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->tmpfile_arg), 
                ...
                &(local_args_info.tmpfile_given), optarg, 0, "/tmp/safira-XXXXXX", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "tmpfile", '-',
                additional_error))
              goto failure;
  ...
  if (args_info->operations_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group operations were given. One is required%s.\n", argv[0], args_info->operations_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
