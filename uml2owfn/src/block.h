...
class Block
{
    ...
    void inclusiveDecisionPatternRecursively(Block* decision, Place* centralNode, set<string>& currentOutputBranches, string number, PetriNet* PN, map<string,bool>& generated, set<set<string> >& powerSet);
  ...
  public:
    ...
    void translateConnections(PetriNet* PN);
    ...
    PetriNet* returnNet(PetriNet* PN);
