...
import hub.top.lang.flowcharts.ptnet.PTnetToTINA;

import org.eclipse.core.resources.IFile;
import org.eclipse.emf.common.util.URI;
import org.eclipse.emf.transaction.TransactionalEditingDomain;

public class ConvertFileWizard_PTnetToTINA extends ConvertFileWizard {

	public ConvertFileWizard_PTnetToTINA(URI domainModelURI, Object resourceRoot,
...
//    URI targetURI = URI.createPlatformResourceURI(targetFile.getFullPath().toString(), true);
    ...
    if (modelObject instanceof org.eclipse.gmf.runtime.notation.Diagram) {
    	...
    	if (d.getElement() instanceof hub.top.editor.ptnetLoLA.PtNet) {
    		// we understand P/T-Nets, invoke translation to TINA file
    		PTnetToTINA toTINA = new PTnetToTINA((PtNet) d.getElement(), targetFile.getName());
    	  	FileIOHelper.writeFile(targetFile, toTINA.createNetFile());
      ...
      PTnetToTINA toTINA = new PTnetToTINA((PtNet)modelObject, targetFile.getName());
      FileIOHelper.writeFile(targetFile, toTINA.createNetFile());
