...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nInput/Output:",
  "  When called without an input file, Hello reads from the standard input \n  stream. When called without an output parameter, Hello writes to the standard \n  output stream. If no filename is given for the output option Hello creates a \n  file with a temporary name.\n",
  "  -o, --output[=FILENAME]  Wendy's output.",
  "  This option is used when Wendy's output should be stored to a file.\n",
  "\nConfiguration:",
  "  <<-- Hello relies on several other tools. These options configure Hello to \n  find these tools. -->>\n",
  "  -c, --config=FILE        Read configuration from file.",
  "  If no file is given, Hello first tries to parse file `hello.conf' from the \n  sysconf directory (usually `/usr/local/etc'; written in case Hello was \n  installed) and then from the current working directory. If neither file was \n  found, the standard values are assumed.\n",
  "      --wendy=FILENAME     Set the path and binary of Wendy.  (default=`wendy')",
  "  The Wendy binary. Wendy can be downloaded from \n  http://service-technology.org/wendy and compiled using `make wendy'.\n",
  "      --tmpfile=FILENAME   Set the path and name of temporary files.  \n                             (default=`/tmp/hello-XXXXXX')",
  "  The filename Hello should use to create temporary files (i.e., the output \n  derived from Wendy). The filename should end with `XXXXXX' which is replaced \n  at runtime with a random string.\n",
  "      --noClean            Do not delete temporary files.  (default=off)",
  "  Any temporary files created will be kept after Hello terminates.\n",
  "\nDebugging:",
  "  These options control how much debug output Hello creates.\n",
  "  -v, --verbose            Show verbose messages.  (default=off)",
  "  Show verbose information reporting intermediate steps.\n",
  "      --bug                Write configuration information into a file \n                             `bug.log'.  (default=off)",
  "  This output file gives information on the machine Hello was configured and \n  compiled which should help to fix bugs. The file `bug.log' should be attached \n  to bug reports.\n",
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[14] = gengetopt_args_info_detailed_help[19];
  gengetopt_args_info_full_help[15] = gengetopt_args_info_detailed_help[20];
  gengetopt_args_info_full_help[16] = gengetopt_args_info_detailed_help[22];
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[10] = gengetopt_args_info_detailed_help[16];
  gengetopt_args_info_help[11] = gengetopt_args_info_detailed_help[18];
  gengetopt_args_info_help[12] = gengetopt_args_info_detailed_help[19];
  gengetopt_args_info_help[13] = gengetopt_args_info_detailed_help[20];
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->tmpfile_arg = gengetopt_strdup ("/tmp/hello-XXXXXX");
  args_info->tmpfile_orig = NULL;
  args_info->noClean_flag = 0;
  args_info->verbose_flag = 0;
  args_info->bug_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->config_help = gengetopt_args_info_detailed_help[10] ;
  args_info->wendy_help = gengetopt_args_info_detailed_help[12] ;
  args_info->tmpfile_help = gengetopt_args_info_detailed_help[14] ;
  args_info->noClean_help = gengetopt_args_info_detailed_help[16] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[20] ;
  args_info->bug_help = gengetopt_args_info_detailed_help[22] ;
  args_info->stats_help = gengetopt_args_info_detailed_help[24] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->bug_given)
    write_into_file(outfile, "bug", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVo::c:v", long_options, &option_index);
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "tmpfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->tmpfile_arg), 
                ...
                &(local_args_info.tmpfile_given), optarg, 0, "/tmp/hello-XXXXXX", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "tmpfile", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "bug") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->bug_flag), 0, &(args_info->bug_given),
                &(local_args_info.bug_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "bug", '-',
                additional_error))
              goto failure;
