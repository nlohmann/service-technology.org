...
void PetriNet::output_pnml(ostream *output) const
{
  ...
  (*output) << "<!--" << endl;
  (*output) << "  Petri net created by " << this->getPackageString() << " reading file " << globals::filename << "." << endl;
...
void PetriNet::output_ina(ostream *output) const
{
  ...
  (*output) << "generated by: " << this->getPackageString() << endl;
...
void PetriNet::output_lola(ostream *output) const
{
  ...
  (*output) << "{ Petri net created by " << this->getPackageString() << " reading " << globals::filename << " }" << endl << endl;
...
void PetriNet::output_owfn(ostream *output) const
{
  ...
  (*output) << "  input file:   `" << globals::filename << "'" << endl;
#endif
  (*output) << "  invocation:   `" << this->getInvocation() << "'" << endl;
  (*output) << "  net size:     " << information() << endl;
  (*output) << "}" << endl << endl;
