package hub.top.editor.ptnetLoLA.diagram.view.factories;
 ...
 * @generated
 */
public class TransitionViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = hub.top.editor.ptnetLoLA.diagram.part.PtnetLoLAVisualIDRegistry
