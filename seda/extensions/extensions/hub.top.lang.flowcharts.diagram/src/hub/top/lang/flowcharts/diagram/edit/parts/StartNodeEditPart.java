...
import hub.top.lang.flowcharts.diagram.edit.policies.StartNodeItemSemanticEditPolicy;
...
public class StartNodeEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof StartNodeLabelEditPart) {
      ((StartNodeLabelEditPart) childEditPart).setLabel(getPrimaryShape()
