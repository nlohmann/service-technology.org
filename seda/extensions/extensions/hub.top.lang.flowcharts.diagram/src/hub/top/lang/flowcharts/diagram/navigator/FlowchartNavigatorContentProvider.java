  ...
  private Object[] getViewChildren(View view, Object parentElement) {
    ...
    case WorkflowDiagramEditPart.VISUAL_ID: {
      ...
      FlowchartNavigatorGroup links = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_WorkflowDiagram_79_links,
    ...
    case StartNodeEditPart.VISUAL_ID: {
      ...
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_StartNode_1001_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_StartNode_1001_outgoinglinks,
    ...
    case EndnodeEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Endnode_1002_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Endnode_1002_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case SimpleActivityEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_SimpleActivity_1003_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_SimpleActivity_1003_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case SubprocessEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Subprocess_1004_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Subprocess_1004_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case SplitNodeEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_SplitNode_1006_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_SplitNode_1006_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case MergeNodeEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_MergeNode_1007_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_MergeNode_1007_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case FlowEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Flow_1008_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Flow_1008_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getChildrenByType(
    ...
    case TransientResourceEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_TransientResource_1009_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_TransientResource_1009_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case DocumentEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Document_1010_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_Document_1010_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case PersistentResourceEditPart.VISUAL_ID: {
      Collection result = new ArrayList();
      FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_PersistentResource_1011_incominglinks,
          "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_PersistentResource_1011_outgoinglinks,
          "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      Collection connectedViews = getIncomingLinksByType(Collections
          .singleton(view), DiagramArcEditPart.VISUAL_ID);
      incominglinks.addChildren(createNavigatorItems(connectedViews,
    ...
    case DiagramArcEditPart.VISUAL_ID: {
      ...
      FlowchartNavigatorGroup target = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_DiagramArc_3001_target,
          "icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      FlowchartNavigatorGroup source = new FlowchartNavigatorGroup(
          Messages.NavigatorGroupName_DiagramArc_3001_source,
