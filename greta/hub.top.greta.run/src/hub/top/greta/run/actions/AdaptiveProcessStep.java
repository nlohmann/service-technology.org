...
public class AdaptiveProcessStep extends SimulationInteractiveAction {
  ...
  public String getID() {
	 ...
	 * and extend {@link AdaptiveProcessStep#activatedNormalOclets} 
   * or {@link AdaptiveProcessStep#activatedAntiOclets}
