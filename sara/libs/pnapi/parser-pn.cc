...
#define yyparse pnapi_pn_yyparse
#define yylex   pnapi_pn_yylex
#define yyerror pnapi_pn_yyerror
#define yylval  pnapi_pn_yylval
#define yychar  pnapi_pn_yychar
#define yydebug pnapi_pn_yydebug
#define yynerrs pnapi_pn_yynerrs
...
static const yytype_uint8 yyrline[] =
{
     ...
     128,   130,   144,   145,   148,   150,   158,   160,   168,   169
};
#endif
...
#line 112 "parser-pn.yy"
    { 
    std::string ident = (yyvsp[(2) - (3)].yt_str);
    free((yyvsp[(2) - (3)].yt_str));

    if (in_arc_list) 
    {
      tempNodeMap_[ident] = (yyvsp[(3) - (3)].yt_uInt);
...
#line 131 "parser-pn.yy"
  ...
  case 12:
#line 144 "parser-pn.yy"
    { (yyval.yt_uInt) = 1; }
    break;

  case 13:
#line 145 "parser-pn.yy"
    { (yyval.yt_uInt) = (yyvsp[(2) - (3)].yt_uInt); }
    break;

  case 15:
#line 151 "parser-pn.yy"
    { 
    arcs_[(yyvsp[(2) - (4)].yt_str)] = tempNodeMap_;
    tempNodeMap_.clear();
