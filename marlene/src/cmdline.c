/*
  ...
  gengetopt --input=cmdline.ggo --long-help --include-getopt --show-required --unamed-opts=FILE --no-handle-version --conf-parser
...
const char *gengetopt_args_info_purpose = "Synthesizing behavioral adapters.";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [-h|--help] [--full-help] [-V|--version] [-rFILE|--rulefile=FILE] \n         [-mBOUND|--messagebound=BOUND] [-a|--asyncif] [-p|--complementplaces] \n         [-v|--verbose] [-w|--veryverbose] [-cFILE|--config=FILE] [FILE]...";

const char *gengetopt_args_info_description = "About Marlene:";
...
const char *gengetopt_args_info_full_help[] = {
  ...
  "\nCore parameters:",
  "  -t, --type=TYPE           Parameter for compatibility with Fiona: the \n                              parameter '-t og' is equivalent to '--og'.  \n                              (possible values=\"og\", \"OG\")",
  "  -r, --rulefile=FILE       File containing rules for building the rewriter \n                              part of the adapter",
  "\nOptions:",
  "  -m, --messagebound=BOUND  Sets the message bound (i.e., the maximal number of \n                              messages per channel). Values from the range \n                              1..255 are allowed.  (default=`1')",
  "  -a, --asyncif             Creates an asynchronous interface between adapter \n                              engine and controller. (Default is synchronous.)  \n                              (default=off)",
  "  -p, --complementplaces    Creates complementary places in the engine part of \n                              the adapter (only in an intermediate state), in \n                              order to avoid unbounded places. Capacity of the \n                              places is influenced by the message bound.  \n                              (default=on)",
  "\nDebug:",
  "  -v, --verbose             Verbose output.  (default=off)",
  "  -w, --veryverbose         Prints a lot of code information. Has only an \n                              effect on debug builds!  (default=off)",
  "\nConfiguration:",
  "  Marlene relies on some other tools. These options configure Marlene to find \n  these tools.\n",
  "      --wendy=FILE          Set the name of the Wendy binary used to build \n                              most-permissive partners.  (default=`wendy')",
  "  -c, --config=FILE         Read configuration from file. If no file is given, \n                              Marlene first tries to parse file 'marlene.conf' \n                              from the sysconf directory (usually \n                              '/usr/local/etc'; written in case Marlene was \n                              installed) and then from the current working \n                              directory. If neither file was found, the \n                              standard value for 'wendy' is assumed.",
    0
};
...
char *cmdline_parser_type_values[] = {"og", "OG", 0} ;	/* Possible values for type.  */
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->rulefile_given = 0 ;
  args_info->messagebound_given = 0 ;
  args_info->asyncif_given = 0 ;
  args_info->complementplaces_given = 0 ;
  args_info->verbose_given = 0 ;
  args_info->veryverbose_given = 0 ;
  args_info->wendy_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->rulefile_arg = NULL;
  args_info->rulefile_orig = NULL;
  args_info->messagebound_arg = 1;
  args_info->messagebound_orig = NULL;
  args_info->asyncif_flag = 0;
  args_info->complementplaces_flag = 1;
  args_info->verbose_flag = 0;
  args_info->veryverbose_flag = 0;
  args_info->wendy_arg = gengetopt_strdup ("wendy");
  args_info->wendy_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->type_help = gengetopt_args_info_full_help[4] ;
  args_info->rulefile_help = gengetopt_args_info_full_help[5] ;
  args_info->messagebound_help = gengetopt_args_info_full_help[7] ;
  args_info->asyncif_help = gengetopt_args_info_full_help[8] ;
  args_info->complementplaces_help = gengetopt_args_info_full_help[9] ;
  args_info->verbose_help = gengetopt_args_info_full_help[11] ;
  args_info->veryverbose_help = gengetopt_args_info_full_help[12] ;
  args_info->wendy_help = gengetopt_args_info_full_help[15] ;
  args_info->config_help = gengetopt_args_info_full_help[16] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->rulefile_arg));
  free_string_field (&(args_info->rulefile_orig));
  free_string_field (&(args_info->messagebound_orig));
  free_string_field (&(args_info->wendy_arg));
  free_string_field (&(args_info->wendy_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->rulefile_given)
    write_into_file(outfile, "rulefile", args_info->rulefile_orig, 0);
  if (args_info->messagebound_given)
    write_into_file(outfile, "messagebound", args_info->messagebound_orig, 0);
  if (args_info->asyncif_given)
    write_into_file(outfile, "asyncif", 0, 0 );
  if (args_info->complementplaces_given)
    write_into_file(outfile, "complementplaces", 0, 0 );
  if (args_info->verbose_given)
    write_into_file(outfile, "verbose", 0, 0 );
  if (args_info->veryverbose_given)
    write_into_file(outfile, "veryverbose", 0, 0 );
  if (args_info->wendy_given)
    write_into_file(outfile, "wendy", args_info->wendy_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "type",	1, NULL, 't' },
        { "rulefile",	1, NULL, 'r' },
        { "messagebound",	1, NULL, 'm' },
        { "asyncif",	0, NULL, 'a' },
        { "complementplaces",	0, NULL, 'p' },
        { "verbose",	0, NULL, 'v' },
        { "veryverbose",	0, NULL, 'w' },
        { "wendy",	1, NULL, 0 },
        { "config",	1, NULL, 'c' },
        { NULL,	0, NULL, 0 }
      };
      ...
      c = custom_getopt_long (argc, argv, "hVt:r:m:apvwc:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 't':	/* Parameter for compatibility with Fiona: the parameter '-t og' is equivalent to '--og'..  */
        
        
          if (update_arg( (void *)&(args_info->type_arg), 
               &(args_info->type_orig), &(args_info->type_given),
              &(local_args_info.type_given), optarg, cmdline_parser_type_values, 0, ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "type", 't',
              additional_error))
            goto failure;
          ...
          break;
        case 'r':	/* File containing rules for building the rewriter part of the adapter.  */
        
        
          if (update_arg( (void *)&(args_info->rulefile_arg), 
               &(args_info->rulefile_orig), &(args_info->rulefile_given),
              &(local_args_info.rulefile_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "rulefile", 'r',
              additional_error))
            goto failure;
          ...
          break;
        case 'm':	/* Sets the message bound (i.e., the maximal number of messages per channel). Values from the range 1..255 are allowed..  */
        
        
          if (update_arg( (void *)&(args_info->messagebound_arg), 
               &(args_info->messagebound_orig), &(args_info->messagebound_given),
              &(local_args_info.messagebound_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "messagebound", 'm',
              additional_error))
            goto failure;
          ...
          break;
        case 'a':	/* Creates an asynchronous interface between adapter engine and controller. (Default is synchronous.).  */
        
        
          if (update_arg((void *)&(args_info->asyncif_flag), 0, &(args_info->asyncif_given),
              &(local_args_info.asyncif_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "asyncif", 'a',
              additional_error))
            goto failure;
        
          break;
        case 'p':	/* Creates complementary places in the engine part of the adapter (only in an intermediate state), in order to avoid unbounded places. Capacity of the places is influenced by the message bound..  */
        
        
          if (update_arg((void *)&(args_info->complementplaces_flag), 0, &(args_info->complementplaces_given),
              &(local_args_info.complementplaces_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "complementplaces", 'p',
              additional_error))
            goto failure;
        ...
        case 'v':	/* Verbose output..  */
          ...
          break;
        case 'w':	/* Prints a lot of code information. Has only an effect on debug builds!.  */
        
        
          if (update_arg((void *)&(args_info->veryverbose_flag), 0, &(args_info->veryverbose_given),
              &(local_args_info.veryverbose_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "veryverbose", 'w',
              additional_error))
            goto failure;
        
          break;
        case 'c':	/* Read configuration from file. If no file is given, Marlene first tries to parse file 'marlene.conf' from the sysconf directory (usually '/usr/local/etc'; written in case Marlene was installed) and then from the current working directory. If neither file was found, the standard value for 'wendy' is assumed..  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "wendy") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->wendy_arg), 
                 &(args_info->wendy_orig), &(args_info->wendy_given),
                &(local_args_info.wendy_given), optarg, 0, "wendy", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "wendy", '-',
                additional_error))
              goto failure;
