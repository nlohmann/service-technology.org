 ...
 * @generated
 */
public class ConditionPreNetItemSemanticEditPolicy
		extends
	...
	public boolean equalParentNet(CreateRelationshipRequest req) {
		//System.out.println("ConditionPreNetItemSemanticEditPolicy.equalParentNet(req) START.");
	...
	public boolean equalParentNet(ReorientRelationshipRequest req) {
		//System.out.println("ConditionPreNetItemSemanticEditPolicy.equalParentNet(ReorientReq) START.");
