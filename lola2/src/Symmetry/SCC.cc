...
SCC::SCC()
{
    ...
    dfs = 0;
    elems = new scc_vertex_t[Net::Card[PL] + Net::Card[TR]];
    nextElem = 0;
    tarjan = new scc_vertex_t[Net::Card[PL] + Net::Card[TR]];
    nextTarjan = 0;
    ...
    arcs[PRE] = new index_t*[sccs];
    arcs[POST] = new index_t*[sccs];
    mult[PRE] = new mult_t*[sccs];
    mult[POST] = new mult_t*[sccs];
    card[PRE] = new index_t[sccs]();
    card[POST] = new index_t[sccs]();
    intra[PRE] = new index_t[sccs]();
    intra[POST] = new index_t[sccs]();
