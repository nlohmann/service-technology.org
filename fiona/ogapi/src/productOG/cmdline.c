...
const char *gengetopt_args_info_purpose = "Calculating product OGs";

const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [OPTIONS]... [FILES]...";

const char *gengetopt_args_info_description = "About productOG:";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nDebugging:",
  "  These options control how much debug output the comiplers create.\n",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignoreEmptyNode_help = gengetopt_args_info_detailed_help[5] ;
  args_info->show_states_help = gengetopt_args_info_detailed_help[6] ;
