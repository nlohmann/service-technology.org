...
#define yyparse         pnapi_sa_yyparse
#define yylex           pnapi_sa_yylex
#define yyerror         pnapi_sa_yyerror
#define yylval          pnapi_sa_yylval
#define yychar          pnapi_sa_yychar
#define yydebug         pnapi_sa_yydebug
#define yynerrs         pnapi_sa_yynerrs


/* Copy the first part of user declarations.  */

/* Line 189 of yacc.c  */
#line 18 "parser-sa.yy"
...
{
       0,     0,     3,    10,    11,    15,    16,    20,    21,    25,
      26,    28,    32,    33,    38,    39,    42,    45,    50,    51
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      17,     0,    -1,     3,    18,    19,    20,     6,    22,    -1,
      -1,     4,    21,    12,    -1,    -1,     5,    21,    12,    -1,
      -1,     9,    21,    12,    -1,    -1,    15,    -1,    21,    10,
      15,    -1,    -1,    22,    14,    23,    24,    -1,    -1,    11,
       8,    -1,    11,     7,    -1,    11,     8,    10,     7,    -1,
      -1,    24,    15,    13,    14,    -1
};
...
{
       0,    67,    67,    89,    91,   109,   111,   129,   131,   140,
     142,   143,   147,   149,   221,   223,   224,   225,   229,   231
};
#endif
...
{
  "$end", "error", "$undefined", "KEY_INTERFACE", "KEY_INPUT",
  "KEY_OUTPUT", "KEY_NODES", "KEY_FINAL", "KEY_INITIAL", "KEY_SYNCHRONOUS",
  "COMMA", "COLON", "SEMICOLON", "ARROW", "NUMBER", "IDENT", "$accept",
  "sa", "input", "output", "synchronous", "identlist", "nodes",
  "annotation", "successors", 0
};
#endif
...
{
       0,     3,     0,     9,     5,     1,    10,     0,     9,     7,
       0,     4,     0,     9,     0,    11,     6,     0,    12,     8,
       2,    14,     0,    18,    16,    15,    13,     0,     0,    17,
       0,    19
};
...
{
      -1,     4,    12,    -2,     9,   -10,   -10,    -9,    -2,     6,
       1,   -10,    -6,    -2,    11,   -10,   -10,    -3,   -10,   -10,
       5,     7,     3,   -10,   -10,    10,     8,    14,    13,   -10,
      15,   -10
};
...
{
      12,    10,     1,    11,    10,    17,    16,    10,     3,    19,
      24,    25,     5,     6,     8,    13,    15,    18,    22,    21,
      27,    29,     0,    28,     0,     0,    30,     0,     0,    31
};

static const yytype_int8 yycheck[] =
{
       8,    10,     3,    12,    10,    13,    12,    10,     4,    12,
       7,     8,     0,    15,     5,     9,    15,     6,    11,    14,
      10,     7,    -1,    15,    -1,    -1,    13,    -1,    -1,    14
};
...
{
       0,     3,    17,     4,    18,     0,    15,    21,     5,    19,
      10,    12,    21,     9,    20,    15,    12,    21,     6,    12,
      22,    14,    11,    23,     7,     8,    24,    10,    15,     7,
      13,    14
};
...
/* Line 1455 of yacc.c  */
#line 142 "parser-sa.yy"
    { identlist.push_back(std::string((yyvsp[(1) - (1)].yt_str))); free((yyvsp[(1) - (1)].yt_str)); }
    break;

  case 11:

/* Line 1455 of yacc.c  */
#line 143 "parser-sa.yy"
    { identlist.push_back(std::string((yyvsp[(3) - (3)].yt_str))); free((yyvsp[(3) - (3)].yt_str)); }
    break;

  case 13:

/* Line 1455 of yacc.c  */
#line 150 "parser-sa.yy"
    {
    if (sa2sm)
    {
      if (places_.count((yyvsp[(2) - (4)].yt_int)) == 0)
      {
        std::stringstream ss;
        std::string num;
        ss << (yyvsp[(2) - (4)].yt_int);
        ...
        places_[(yyvsp[(2) - (4)].yt_int)] = place_;
      }
      else
        place_ = places_[(yyvsp[(2) - (4)].yt_int)];
      if (initial_)
        place_->mark();
      if (final_)
      {
    ...
    {
	    if (states_.count((yyvsp[(2) - (4)].yt_int)) == 0)
	    {
	    	state_ = &pnapi_sa_yyautomaton.createState((yyvsp[(2) - (4)].yt_int));
	      states_[(yyvsp[(2) - (4)].yt_int)] = state_;
	    }
	    else
	      state_ = states_[(yyvsp[(2) - (4)].yt_int)];
	    if (initial_)
	      state_->initial();
	    if (final_)
	      state_->final();
...
/* Line 1455 of yacc.c  */
#line 225 "parser-sa.yy"
    { initial_ = final_ = true; }
    break;

  case 19:

/* Line 1455 of yacc.c  */
#line 232 "parser-sa.yy"
    {
    if (sa2sm)
    {
      if (places_.count((yyvsp[(4) - (4)].yt_int)) == 0)
      {
        std::stringstream ss;
        std::string num;
        ss << (yyvsp[(4) - (4)].yt_int);
        ...
        places_[(yyvsp[(4) - (4)].yt_int)] = edgePlace_;
      }
    }
    else
    {
	    if (states_.count((yyvsp[(4) - (4)].yt_int)) == 0)
	    {
	      edgeState_ = &pnapi_sa_yyautomaton.createState((yyvsp[(4) - (4)].yt_int));
	      states_[(yyvsp[(4) - (4)].yt_int)] = edgeState_;
	    }
	  }

    edgeLabel_ = (yyvsp[(2) - (4)].yt_str);
    free((yyvsp[(2) - (4)].yt_str));
    ...
    succState_.push_back((yyvsp[(4) - (4)].yt_int));
