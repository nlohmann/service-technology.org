...
import hub.top.lang.flowcharts.diagram.edit.policies.StartNode2ItemSemanticEditPolicy;
...
public class StartNode2EditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof StartNodeLabel2EditPart) {
      ((StartNodeLabel2EditPart) childEditPart).setLabel(getPrimaryShape()
