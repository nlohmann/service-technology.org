...
public class ConvertDiagramFileAction_PTnetToRomeo extends ConvertDiagramFileAction {


	/**
	 * Create a {@link ConvertFileWizard_PTnetToRomeo} to convert a selected
	 * P/T net to an Roméo document.
	 * 
	...
	{
		ConvertFileWizard wizard = new ConvertFileWizard_PTnetToRomeo(
				srcURI, root, editingDomain, "xml");
		wizard.setWindowTitle("Convert P/T-Net to Roméo file");
		return wizard;
	}
}
