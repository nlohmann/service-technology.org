...
/******************************************************************************
 This function overrides the _exit() function to allow LoLA to be called as a
 library. All _exit() calls are replaced by this function that throws an
 exception to the caller function instead (defined in userconfig.H).         */
#include <stdexcept>
